 ...
 *
 * Usage:
 *   bun run backend/src/db/seed/scripts/patch-image-urls.ts --dry
 *   IMAGE_CDN_BASE=https://cdn.example.com bun run backend/src/db/seed/scripts/patch-image-urls.ts
 */
