...
//   2. Fill tags (slugs from data/tags/ only — never invent). Pre-fill via
//      \`auto-tag.ts --candidates\`
//   3. Review keyIngredients pre-filled by \`infer-key-ingredients.ts\`
//      (entries marked \`/* AUTO-INFERRED */\` need pruning + notes/concentrations
//      before the marker is removed). Any added slug must come from INGREDIENT_SLUGS
