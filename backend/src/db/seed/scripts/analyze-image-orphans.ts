 ...
 *
 * Usage:
 *   bun run backend/src/db/seed/scripts/analyze-image-orphans.ts
 *   bun run backend/src/db/seed/scripts/analyze-image-orphans.ts --brand uriage
 *   bun run backend/src/db/seed/scripts/analyze-image-orphans.ts --top 50
 */
