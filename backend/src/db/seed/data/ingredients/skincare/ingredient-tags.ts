...
export const skincareTagMap: IngredientTagMap = {
  ...
  [INGREDIENT_SLUGS.CERAMIDE_AP]: {
    ...
    secondary: [TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.BIOMIMETIQUE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.PHA]: {
    ...
    secondary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.ECLAT, TAG_SLUGS.ANTI_AGE, TAG_SLUGS.ROSACEE],
    avoid: [TAG_SLUGS.BARRIERE_CUTANEE_ALTEREE],
  },
