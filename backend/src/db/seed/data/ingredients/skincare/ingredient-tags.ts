...
export const skincareTagMap: IngredientTagMap = {
  ...
  [INGREDIENT_SLUGS.CHONDRUS_CRISPUS]: {
    primary: [TAG_SLUGS.HUMECTANT, TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.DESHYDRATATION],
  ...
  [INGREDIENT_SLUGS.PETROLATUM]: {
    primary: [TAG_SLUGS.OCCLUSIF, TAG_SLUGS.EMOLLIENT, TAG_SLUGS.EFFET_PROTECTEUR],
    secondary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.PEAU_SECHE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.UNDARIA_PINNATIFIDA]: {
    ...
    secondary: [TAG_SLUGS.REPULPANT, TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.HUILE_DE_RICIN]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.EFFET_PROTECTEUR],
  ...
  [INGREDIENT_SLUGS.ALLANTOIN]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.EFFET_PROTECTEUR],
    secondary: [
      TAG_SLUGS.REPARATEUR,
      TAG_SLUGS.BARRIERE_CUTANEE,
      TAG_SLUGS.ANTI_ROUGEURS,
  ...
  [INGREDIENT_SLUGS.BEEF_TALLOW]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.EFFET_PROTECTEUR],
  ...
  [INGREDIENT_SLUGS.HUMECTANTS_EMOLLIENTS_OCCLUSIFS]: {
    primary: [TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.BARRIERE_CUTANEE],
    secondary: [TAG_SLUGS.HUMECTANT, TAG_SLUGS.EMOLLIENT, TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.DIMETHICONE]: {
    primary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.BARRIERE_CUTANEE],
    secondary: [TAG_SLUGS.EMOLLIENT],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.TWO_OLEAMIDO_1_3_OCTADECANEDIOL]: {
    primary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.EMOLLIENT],
    secondary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.PEAU_SENSIBLE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.HYDROCOLLOID]: {
    ...
    secondary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.POST_ACNE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.AHNFELTIA_CONCINNA]: {
    primary: [TAG_SLUGS.REPARATEUR, TAG_SLUGS.HUMECTANT],
    secondary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.TREHALOSE]: {
    primary: [TAG_SLUGS.HUMECTANT, TAG_SLUGS.EFFET_PROTECTEUR],
  ...
  [INGREDIENT_SLUGS.BEURRE_CACAO]: {
    primary: [TAG_SLUGS.EMOLLIENT],
    secondary: [TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.COMEDOGENE],
    avoid: [TAG_SLUGS.PEAU_GRASSE, TAG_SLUGS.ANTI_ACNE],
  },
  ...
  [INGREDIENT_SLUGS.TOCOPHERYL_ACETATE]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.EFFET_PROTECTEUR],
  ...
  [INGREDIENT_SLUGS.COLLOIDAL_OATMEAL]: {
    ...
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.ECZEMA, TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.SODIUM_LACTATE]: {
    ...
    secondary: [TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.GLYCERYL_STEARATE]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.PEAU_SECHE],
    secondary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.PEAU_NORMALE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.TRIMETHOXYBENZYL_ACETYLSINAPATE]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_AGE],
    secondary: [TAG_SLUGS.PHOTO_VIEILLISSEMENT, TAG_SLUGS.EFFET_PROTECTEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.BIOSACCHARIDE_GUM_4]: {
    primary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.HUMECTANT],
  ...
  [INGREDIENT_SLUGS.MELANIN]: {
    primary: [TAG_SLUGS.EFFET_PROTECTEUR, TAG_SLUGS.PHOTO_PROTECTION],
    secondary: [TAG_SLUGS.LUMIERE_BLEUE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.ACETYL_ZINGERONE]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_AGE, TAG_SLUGS.ANTI_INFLAMMATOIRE],
    secondary: [TAG_SLUGS.HYPERPIGMENTATION, TAG_SLUGS.ECLAT],
    avoid: [],
  },
  [INGREDIENT_SLUGS.GENISTEIN]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_AGE],
    secondary: [TAG_SLUGS.POLYPHENOLS, TAG_SLUGS.PHOTO_VIEILLISSEMENT],
    avoid: [],
  },
  [INGREDIENT_SLUGS.QUERCETIN]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_INFLAMMATOIRE],
    secondary: [TAG_SLUGS.ANTI_ROUGEURS, TAG_SLUGS.POLYPHENOLS],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.HESPERIDIN_METHYL_CHALCONE]: {
    primary: [TAG_SLUGS.ANTI_ROUGEURS, TAG_SLUGS.ANTI_OXYDANT],
    secondary: [TAG_SLUGS.COUPEROSE, TAG_SLUGS.ROSACEE, TAG_SLUGS.POLYPHENOLS],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.TETRAHYDRODIFERULOYLMETHANE]: {
    primary: [TAG_SLUGS.ANTI_INFLAMMATOIRE, TAG_SLUGS.HYPERPIGMENTATION],
    secondary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_TACHES],
    avoid: [],
  },
  [INGREDIENT_SLUGS.NARINGENIN]: {
    primary: [TAG_SLUGS.ANTI_ROUGEURS, TAG_SLUGS.ANTI_INFLAMMATOIRE],
    secondary: [TAG_SLUGS.POLYPHENOLS, TAG_SLUGS.PEAU_SENSIBLE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.GLUCOSYLRUTIN]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.PHOTO_VIEILLISSEMENT],
    secondary: [TAG_SLUGS.POLYPHENOLS, TAG_SLUGS.PHOTO_PROTECTION],
    avoid: [],
  },
  [INGREDIENT_SLUGS.RUTIN]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.POLYPHENOLS, TAG_SLUGS.COUPEROSE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.SALICORNIA_HERBACEA]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.BIOMIMETIQUE],
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.DESHYDRATATION],
    avoid: [],
  },
  [INGREDIENT_SLUGS.AZELAMIDE_MEA]: {
    primary: [TAG_SLUGS.ANTI_ACNE, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.POST_ACNE, TAG_SLUGS.SEBO_REGULATEUR],
    avoid: [],
  },
  [INGREDIENT_SLUGS.AZELAMIDOPROPYL_DIMETHYL_AMINE]: {
    primary: [TAG_SLUGS.ANTI_ACNE, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.POST_ACNE, TAG_SLUGS.MICROBIOME],
    avoid: [],
  },
  [INGREDIENT_SLUGS.HYDROXYSTEARIC_ACID_10]: {
    primary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.EMOLLIENT],
    secondary: [TAG_SLUGS.REPARATEUR, TAG_SLUGS.ANTI_INFLAMMATOIRE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.PASSIFLORA_EDULIS]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.ANTI_OXYDANT],
    secondary: [TAG_SLUGS.APAISANT, TAG_SLUGS.BARRIERE_CUTANEE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.MYROTHAMNUS_FLABELLIFOLIA]: {
    primary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.DESHYDRATATION],
    secondary: [TAG_SLUGS.BIOMIMETIQUE, TAG_SLUGS.BARRIERE_CUTANEE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.GLYCOLIDE]: {
    primary: [TAG_SLUGS.AHA, TAG_SLUGS.ECLAT],
    secondary: [TAG_SLUGS.GRAIN_PEAU, TAG_SLUGS.HYPERPIGMENTATION],
    avoid: [TAG_SLUGS.PEAU_SENSIBLE],
  },
