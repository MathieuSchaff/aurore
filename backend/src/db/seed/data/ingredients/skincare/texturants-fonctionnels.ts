...
export const TEXTURANTS_FONCTIONNELS: IngredientInput[] = [
  {
    ...
    content: `
# Ahnfeltia Concinna : L'Or Rouge des Océans

L'**Ahnfeltia Concinna** est une algue rouge précieuse dont l'extrait concentre la puissance minérale des fonds marins. Utilisé pour sa richesse en protéoglycanes, cet ingrédient est un véritable architecte de l'hydratation durable.

---

## ✨ Points Forts & Bénéfices
* **Hydratation Intense** : Les polymères marins forment un réseau à la surface de la peau pour retenir l'eau au cœur des cellules.
* **Reminéralisation** : Apporte les oligo-éléments essentiels au bon fonctionnement des métabolismes cutanés.
* **Catalyseur d'Actifs** : Améliore la pénétration des autres actifs présents dans la formule.

---

## ⚖️ Transparence Scientifique & Limites
* **Rareté** : Ingrédient haut de gamme dont la qualité dépend fortement des conditions de récolte et de la pureté des eaux d'origine.
* **Preuves Scientifiques** : Bien que son effet hydratant soit validé par l'usage traditionnel et des tests instrumentaux de surface, les données sur son action régénératrice profonde restent à approfondir.

---

## 🛡️ Précautions & Sécurité
* **Pureté Marine** : Nécessite des contrôles stricts pour garantir l'absence de métaux lourds liés à la pollution océanique.
`,
  },
  {
    ...
    content: `
# Biosaccharide Gum-1 : Le Voile de Sérénité

Issu de la fermentation bactérienne de substrats végétaux, le **Biosaccharide Gum-1** est un actif multi-sensoriel. Il agit comme un messager cellulaire capable de moduler la réponse inflammatoire et d'apporter un confort immédiat aux peaux "en crise".

---

## 🔬 Expertise Sensorielle & Biologique
* **Effet S.O.S.** : Réduit significativement les sensations de picotements et d'échauffement dès l'application.
* **Hydratation Progressive** : Crée un film protecteur non occlusif qui capte l'eau et la libère durablement.
* **Lissage Immédiat** : Améliore la texture de la peau en comblant les micro-ridules de surface.

---

## ⚖️ Transparence Scientifique & Limites
* **Action de Surface** : Son efficacité est principalement épidermique. Il ne remplace pas un traitement de fond pour les pathologies cutanées chroniques.
* **Données Cliniques** : Très efficace sur l'apaisement immédiat, mais ses bénéfices anti-âge à long terme sont considérés comme secondaires.

---

## 🛡️ Précautions & Sécurité
* **Biocompatibilité** : Totalement non irritant et non allergisant. Idéal pour les contours des yeux et les peaux réactives.
`,
  },
  {
    name: 'Silica',
    ...
    content: `
# Silica
La silice est un minéral naturel utilisé en cosmétique pour ses propriétés absorbantes et texturisantes.

## INCI
**SILICA**

## Points forts
- **Matifiant** : Absorbe l’excès de sébum.
- **Effet soft-focus** : Floute visuellement les pores et imperfections.
- **Améliore la texture** : Apporte un toucher soyeux et non gras.
- **Stabilisant** : Aide à épaissir ou structurer certaines formules.

## Rôle dans les soins
Très utilisée dans les poudres, fonds de teint, soins matifiants et produits pour peaux grasses.

## Utilisation
- **Cible** : Peaux mixtes à grasses, brillances localisées.
- **Type de soin** : Poudres, crèmes matifiantes, primers, soins anti-brillance.
`,
  },
  {
    ...
    content: `
# Extrait d’Écorce de Saule Noir (Salix Nigra)
Le saule noir contient naturellement des composés salicylés proches de l’acide salicylique, utilisés pour leurs propriétés exfoliantes et purifiantes.

## INCI
**SALIX NIGRA (WILLOW) BARK EXTRACT**

## Points forts
- **Exfoliation douce** : Favorise le renouvellement cellulaire.
- **Purifiant** : Aide à désobstruer les pores.
- **Séborégulateur léger** : Utile pour les peaux mixtes à grasses.
- **Alternative végétale au BHA** : Plus progressive que l’acide salicylique pur.

## Points de vigilance
- Peut être irritant sur peau très sensible.
- À éviter en cas d’allergie aux salicylés.

## Utilisation
- **Cible** : Peaux mixtes, grasses, sujettes aux imperfections.
- **Type de soin** : Sérums purifiants, lotions exfoliantes, nettoyants clarifiants.
`,
  },
  {
    name: 'Extrait de Riz',
    ...
    content: `
# Extrait de Riz (Oryza Sativa)
Le riz est riche en acides aminés, vitamines (notamment B et E), minéraux et composés antioxydants comme l’acide férulique et les tocophérols.

## INCI
**ORYZA SATIVA EXTRACT / ORYZA SATIVA BRAN EXTRACT**

## Points forts
- **Apaisant** : Aide à calmer les rougeurs et irritations légères.
- **Antioxydant** : Protège contre le stress oxydatif.
- **Éclaircissant doux** : Contribue à un teint plus uniforme.
- **Adoucissant** : Améliore la texture de la peau.

## Rôle dans les soins
Souvent utilisé dans les soins asiatiques traditionnels pour illuminer et adoucir la peau, il renforce le confort cutané.

## Utilisation
- **Cible** : Peaux sensibles, ternes ou sujettes aux rougeurs.
- **Type de soin** : Sérums éclat, lotions apaisantes, masques hydratants.
`,
  },
  {
    name: 'Orange Douce',
    ...
    content: `
# Orange Douce (Citrus Aurantium Dulcis)
Issue du zeste ou du fruit de l’orange douce, cette matière première peut être utilisée sous forme d’extrait ou d’huile essentielle. Elle est appréciée pour son parfum agréable et ses propriétés tonifiantes.

## INCI
**CITRUS AURANTIUM DULCIS (ORANGE) PEEL OIL / FRUIT EXTRACT**

## Points forts
- **Tonifiante** : Apporte éclat et fraîcheur au teint.
- **Antioxydante** : Contient naturellement des composés protecteurs (vitamine C, flavonoïdes).
- **Purifiante légère** : Aide à clarifier les peaux mixtes à grasses.
- **Parfum naturel** : Odeur fraîche et énergisante.

## Points de vigilance
- Peut contenir des allergènes naturels (limonene, linalool).
- L’huile essentielle peut être légèrement photosensibilisante.
- À utiliser avec précaution sur peau sensible ou réactive.

## Utilisation
- **Cible** : Teint terne, peaux mixtes à grasses.
- **Type de soin** : Sérums éclat, nettoyants, lotions tonifiantes, soins parfumés.
`,
  },
  {
    name: 'Hydrocolloïde',
    ...
    content: `
  # Hydrocolloïde
  L'hydrocolloïde est un matériau composé de polymères auto-adhésifs et de particules hydrophiles (comme la carboxyméthylcellulose) qui se transforme en gel au contact des exsudats de la peau.

  ## Points forts
  - **Milieu humide** : Maintient un niveau d'hydratation parfait qui accélère la régénération cellulaire par rapport à une plaie laissée à l'air libre.
  - **Effet "seconde peau"** : Protège physiquement contre les bactéries, l'eau et les frottements.
  - **Absorption** : Pompe les impuretés et les liquides (exsudats) sans coller à la plaie.

  ## Rôle dans les patchs ciblés
  Il est idéal pour traiter les petites imperfections ou les ampoules. Il isole la zone, réduit la douleur et empêche de toucher ou de triturer la lésion, limitant ainsi le risque de marque.

  ## Utilisation
  - **Cible** : Boutons, petites plaies, ampoules, brûlures légères.
  - **Type de soin** : Patchs anti-imperfections, pansements techniques.
  `,
  },
  {
