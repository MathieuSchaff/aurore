...
## Points forts
- **Action Décongestionnante** : Stimule la microcirculation sanguine pour réduire visiblement les poches sous les yeux.
- **Anti-cernes** : Aide à drainer les pigments accumulés responsables des cernes colorés.
- **Lipolytique** : Favorise la dégradation des graisses, idéal pour les soins amincissants ou le double menton.
- **Antioxydant** : Protège les cellules contre les dommages causés par les rayons UV.

## Rôle dans les soins
C'est l'ingrédient star des contours des yeux "anti-fatigue" et des gels minceur raffermissants.

## Utilisation
- **Cible** : Regard fatigué, poches, cernes, relâchement cutané localisé.
- **Type de soin** : Sérums contour des yeux, crèmes minceur, soins tonifiants corps.
`,
  },
  {
