...
export const ELGYDIUM_SEED: UnifiedProductSeed[] = [
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/elgydium-blancheur-dentifrice-lot-de-2-x-75ml-265562.webp',
    tags: {
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/elgydium-fix-creme-fixative-extra-fort-45g-265259.webp',
    tags: {
      primary: [TAG_SLUGS.DENTIFRICE],
      secondary: [],
      avoid: [],
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/elgydium-classique-brosse-a-dents-dure-272935.webp',
    tags: {
      primary: [TAG_SLUGS.DENTIFRICE],
      secondary: [],
      avoid: [],
