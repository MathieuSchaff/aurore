...
export const PAULAS_CHOICE_SEED: UnifiedProductSeed[] = [
  {
    ...
    notes: '10% acide glycolique (AHA) pour exfoliation chimique. Contient beurre de karité, antioxydants (vitamine C, vitamine E, thé vert) et agents apaisants (allantoïne, camomille).',
