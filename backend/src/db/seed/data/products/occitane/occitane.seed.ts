...
export const OCCITANE_SEED: UnifiedProductSeed[] = [
...

  {
    ...
    amountUnit: 'ml',
    priceCents: 2900,
    description: 'Huile démaquillante légère qui élimine le maquillage, même waterproof, et nettoie efficacement la peau en éliminant les impuretés et excès de sébum. La peau est +20% plus douce et 82% des utilisateurs trouvent leurs pores moins visibles.',
...

  {
    ...
    notes: 'Formule enrichie en extrait de betterave, extrait de chicorée, fructooligosaccharides et Immortelle bio. Dès 7 jours : barrière cutanée équilibrée, teint homogène +10%. Dès 28 jours : signes de fatigue réduits -10%, grain de peau affiné +9%.',
...

  {
    ...
    amountUnit: 'ml',
    priceCents: 9900,
    description: 'Sérum visage qui agit sur les rides et la fermeté de la peau. Lisse les 5 types de rides du visage et raffermit progressivement la peau dès 14 jours. +17% peau visiblement lissée immédiatement, +73% aspect lissé et fermeté après 56 jours.',
...

  {
    ...
    amountUnit: 'ml',
    priceCents: 6900,
    description: 'Baume contour des yeux qui lisse et comble visiblement les rides et ridules, réduit les poches et les cernes pour révéler la jeunesse du regard sous tous les angles. Recommandé par 9 femmes sur 10. 3 brevets déposés en France.',
...

  {
    ...
    notes: 'Enrichi en Immortelle bio, beurre de karité, adénosine et hexylrésorcinol. Formule avec actifs anti-taches et pro-fermeté.',
