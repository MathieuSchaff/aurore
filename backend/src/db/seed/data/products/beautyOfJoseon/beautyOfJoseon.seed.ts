...
export const BEAUTY_OF_JOSEON_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'g',
    priceCents: 1920,
    description: 'Crème hydratante légère inspirée de la dynastie Joseon, pour peau glowy et équilibrée.',
    notes: 'Occlusion 6/10. Texture crème légère. Eau de riz + ginseng + squalane + niacinamide + céramides + HA.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/E4E9C0E746B1EB/large_1693784340.jpeg?1693784340',
    tags: {
  ...
  },
  {
    ...
    notes: 'Texture aqueuse légère, multi-couches possible. Riche en ginseng (racine, callus, ferment, extraits), niacinamide et panthénol. Idéal pour tous types de peau.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/A76DA6BA8C7322/large_1701889840.jpeg?1701889840',
    tags: {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.PANAX_GINSENG,
        notes: 'Eau de racine de ginseng + callus culture + ferment + extraits – revitalisant, éclat, barrière',},
      {
        slug: INGREDIENT_SLUGS.NIACINAMIDE,
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 1620,
    description: 'Lotion lait de riz hydratante + acides aminés riz. Combat sécheresse, repulpe, absorbe sébum, purifie pores.',
    notes: 'Texture bi-couche (hydratante + poudre sébum). Légère rafraîchissante, tous types (idéal sensible/rougeurs).',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/62BF0968EC8CBB/large_1725261590.png?1725261590',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 2400,
    description: 'Crème solaire hydratante SPF50+ PA++++ à la texture fluide et légère. Version plus hydratante du best-seller Relief Sun, avec eau de riz et panthénol (B5) pour apaiser, hydrater et protéger sans trace blanche ni effet collant.',
    notes: 'Convient à tous les types de peau, idéal peaux mixtes/grasses. Fini frais et non gras, sans parfum ajouté. Absorbe rapidement, bonne base maquillage.',
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque tissu apaisant à la centella asiatica et au ginseng. Rafraîchit, calme rougeurs et irritations.',
    notes: 'Pack de 10 masques de 25 mL chacun. Centella + ginseng + niacinamide + HA. Idéal peaux réactives ou après exposition solaire.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/53C18D8E9563A5/large_1716957831.png?1716957831',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque argileux (kaolin + hectorite) au haricot rouge. Purifie les pores, rafraîchit et matifie sans dessécher.',
    notes: 'Masque wash-off. Pas de parfum. Haricot rouge (Phaseolus Angularis) astringent + kaolin absorbant. Convient peaux grasses et mixtes.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/A4E2C21650C25C/large_1705453784.jpeg?1705453784',
    tags: {
  ...
  },
  {
    ...
    notes: 'Convient aux peaux sensibles, réactives et à tendance couperosique. Artemisia + dipotassium glycyrrhizate en soutien. Texture légère et pénétrante.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/664BCF46300719/large_1701396906.jpeg?1701396906',
    tags: {
      primary: [TAG_SLUGS.ANTI_ROUGEURS, TAG_SLUGS.BARRIERE_CUTANEE],
      secondary: [
        TAG_SLUGS.SERUM,
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Gel exfoliant doux par friction (cellulose). Affine le grain de peau, illumine le teint et nettoie en douceur.',
    notes: 'Exfoliation mécanique légère par « boulochage » de la cellulose. Thé vert + extrait de riz. À utiliser 1-2 fois par semaine sur peau sèche ou légèrement humide.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/EEBF4D32A6BDAF/large_1696653053.jpeg?1696653053',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Gel hydratant léger au haricot rouge, acides aminés et peptides. Texture aqueuse non grasse, idéal pour peaux mixtes à grasses.',
    notes: 'Acetyl Hexapeptide-8 (Argireline) + SH-Oligopeptides anti-âge. Magnesium Ascorbyl Phosphate (vit C stable). Riche en acides aminés et beta-glucan.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/54B6E4C1931F44/large_1693645970.jpeg?1693645970',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum éclat à la vitamine C stable (3-O-Ethyl Ascorbic Acid) et centella asiatica. Antioxydant, illuminant, anti-taches légères.',
    notes: 'Vitamine C stable et pénétrante (3-O-EAA) + bisabolol + beta-glucan. Texture légère. Compatible peau sensible si tolérance vit C OK.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/82092E4D1E7F0A/large_1696653082.jpeg?1696653082',
    tags: {
  ...
  },
  {
    ...
    notes: 'Snail Secretion Filtrate + ginseng eau + extrait + HA triple moléculaire. Niacinamide sébo-régulateur. Tous types de peau, matin et soir.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/9ACFD0482ADDDC/large_1693869762.jpeg?1693869762',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Nettoyant gel doux à la prune verte et thé vert. Élimine impuretés sans altérer le pH cutané.',
    notes: 'Tensioactifs doux (Sodium Cocoyl Isethionate + Sodium Isethionate). Extraits botaniques coréens (artemisia, prune, bleuet). Sans sulfates agressifs.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/923AB76B5A5042/large_1693645920.jpeg?1693645920',
    tags: {
  ...
  },
  {
    ...
    notes: 'Concentrations douces, à utiliser le soir. Éviter si peau très sensible ou traitements dermato en cours. Portulaca + riz en apaisant.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/0052789FE17A1E/large_1689931474.png?1689931474',
    tags: {
  ...
  },
  {
    ...
    notes: 'Alpha-arbutin dépigmentant + niacinamide polyvalent + extrait de riz. Texture sérum légère, hydratant par le panthénol et HA.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/1B64D819A282AD/large_1686610853.jpeg?1686610853',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum contour des yeux au rétinal et ginseng. Lisse les ridules, atténue cernes et poches, renforce la barrière lipidique.',
    notes: 'Retinal (rétinaldéhyde) plus actif que le rétinol, moins irritant que la trétinoïne. Palmitoyltripeptide-5 tenseur. Céramides + cholestérol lipid complex. À utiliser le soir uniquement.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/39A5DD4B8F7260/large_1684921218.jpeg?1684921218',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque rinçable au riz broyé et miel. Exfolie en douceur, nourrit et illumine le teint pour un effet glow immédiat.',
    notes: 'Exfoliation physique légère (poudre de riz hull). Miel + extrait de riz + kaolin. Laisser poser 10-15 min. Compatible tous types de peau sauf peau très réactive.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/3B9C653740E065/large_1744722935.jpeg?1744722935',
    tags: {
  ...
  },
  {
    ...
    notes: 'Filtre minéral (zinc oxide) + filtres chimiques (Butyloctyl Salicylate). Formule anhydre légère. Pas de parfum. Convient peaux claires à moyennes (teinte MP200).',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/962A5906AB398F/large_1754906981.png?1754906981',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Huile démaquillante au ginseng et huile de camélia. Dissout maquillage waterproof et SPF, laisse la peau douce et nourrie.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/A112F1D7CC3F65/large_1741427154.png?1741427154',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE],
      secondary: [
  ...
  },
  {
    ...
    amountUnit: 'g',
    priceCents: 0,
    description: 'Pain nettoyant low pH au riz et huile de coco. Nettoie en douceur sans perturber le microbiome, convient visage et corps.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/2F5F23A6B8CE46/large_1726419758.jpeg?1726419758',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE],
      secondary: [
        TAG_SLUGS.NETTOYANT,
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum éclat à la propolis et niacinamide. Sébo-régulateur, anti-imperfections, unifiant.',
    notes: 'Propolis antibactérienne + niacinamide + betaine salicylate (exfoliant doux BHA). Tea tree + centella en soutien. Idéal peaux acnéiques et mixtes.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/978FB007B8689F/large_1674270729.jpeg?1674270729',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Baume démaquillant au riz et avoine. Fond sur la peau au contact, élimine maquillage et SPF, laisse un sillage doux et nourrissant.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/37DC57BCA3D8AB/large_1637009726.jpeg?1637009726',
    tags: {
