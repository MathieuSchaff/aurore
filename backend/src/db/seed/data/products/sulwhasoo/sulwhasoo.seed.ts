...
export const SULWHASOO_SEED: UnifiedProductSeed[] = [
...

  {
    ...
    tags: {
      ...
      secondary: [TAG_SLUGS.DOUBLE_NETTOYAGE_1, TAG_SLUGS.HUILE_DEMAQUILLANTE, TAG_SLUGS.MATIN, TAG_SLUGS.SOIR, TAG_SLUGS.ZONE_VISAGE],
      avoid: [],
    },
    keyIngredients: [
...

  {
    ...
    tags: {
      ...
      secondary: [TAG_SLUGS.DOUBLE_NETTOYAGE_2, TAG_SLUGS.MOUSSE_NETTOYANTE, TAG_SLUGS.MATIN, TAG_SLUGS.SOIR, TAG_SLUGS.ZONE_VISAGE],
      avoid: [],
    },
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.GLYCERIN, notes: 'Humectant essentiel',},
    ],
  },
...

  {
    ...
    tags: {
      ...
      secondary: [TAG_SLUGS.SLEEPING_MASK, TAG_SLUGS.MASQUE_HEBDO, TAG_SLUGS.SOIR, TAG_SLUGS.ZONE_VISAGE],
      avoid: [],
    },
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.TREHALOSE, notes: `Osmolyte protecteur, stabilise l'hydratation cellulaire` },
    ],
  },
]
