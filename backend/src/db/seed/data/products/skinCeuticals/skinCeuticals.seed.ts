...
export const SKINCEUTICALS_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'ml',
    priceCents: 4489,
    description: 'Soin émollient ultime pour les lèvres. Neutralise les dommages environnementaux (pollution, vent) grâce à des antioxydants puissants. Hydrate intensément, lisse et repulpe les lèvres desséchées tout en prévenant le vieillissement cutané.',
    notes: 'Formule premium avec Silymarine (extrait de chardon-Marie), Vitamine E, Acide Hyaluronique et Hydroxyethyl Urée. Contient également Allantoïne apaisante et peptides régénérants. Texture gel fondante.',
    ...
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.CHARDON_MARIE, notes: 'Extrait de chardon-Marie antioxydant puissant.',},
      { slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE, notes: 'Hydratation profonde et repulpante.',},
      { slug: INGREDIENT_SLUGS.HYDROXYETHYL_UREA, notes: `Dérivé de l'urée aux propriétés hydratantes supérieures.`,},
      { slug: INGREDIENT_SLUGS.ALLANTOIN, notes: 'Agent apaisant végétal.',},
      { slug: INGREDIENT_SLUGS.PALMITOYL_OLIGOPEPTIDE, notes: 'Peptide régénérant stimulant le collagène.',},
