...
export const TIRTIR_SEED: UnifiedProductSeed[] = [
  {
    ...
    notes: 'Formule K-beauty multi-active avec Chondrus Crispus (algue rouge), Chlorella Vulgaris, extrait de canne à sucre et Ceramide NP pour renforcement de la barrière.',
    ...
    keyIngredients: [
      {
        ...
        notes: '12% — régule le sébum et apaise les rougeurs. Concentration intermédiaire efficace.',},
      {
