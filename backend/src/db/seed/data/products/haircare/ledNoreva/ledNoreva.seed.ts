...
export const LED_NOREVA_SEED: UnifiedProductSeed[] = [
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/noreva-psoriane-shampoing-quotidien-apaisant-125ml-278707.webp',
    tags: {
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/noreva-psoriane-shampoing-intensif-apaisant-125ml-263640.webp',
    tags: {
      primary: [HAIRCARE_PRODUCT_TAG_SLUGS.SHAMPOOING],
      secondary: [],
      avoid: [],
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/noreva-sebodiane-ds-serum-lp-seboregulateur-8ml-259742.webp',
    tags: {
      primary: [HAIRCARE_PRODUCT_TAG_SLUGS.SHAMPOOING],
      secondary: [],
      avoid: [],
