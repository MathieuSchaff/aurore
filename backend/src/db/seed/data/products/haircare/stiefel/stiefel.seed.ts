...
export const STIEFEL_SEED: UnifiedProductSeed[] = [
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/stiproxal-shampoing-antipelliculaire-100ml-277692.webp',
    tags: {
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/stiprox-1-5-shampoing-antipelliculaire-100ml-277527.webp',
    tags: {
      primary: [HAIRCARE_PRODUCT_TAG_SLUGS.SHAMPOOING],
      secondary: [],
      avoid: [],
