...
export const EQQUALBERRY_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'ml',
    priceCents: 1517,
    description: 'Tonique quotidien hypoallergénique exfolie doucement (protéase), hydrate (8 HA), apaise avec 5 baies antioxydantes.',
    notes: 'EWG green, sans alcool/parabènes/benzène. Texture légère, tous types (idéal sensible/texturée).',
    ...
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.PROTEASE, notes: 'Enzyme protéase — exfoliation douce sans irritation (alternative AHA/BHA)',},
