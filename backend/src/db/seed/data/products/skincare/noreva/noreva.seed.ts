...
export const NOREVA_SEED: UnifiedProductSeed[] = [
  {
    ...
    priceCents: 2050,
    description:
      'Soin anti-rougeurs avec pigments verts, utilisant un acide hyaluronique spécifique (450 kDa) pour renforcer les défenses de la peau.',
    ...
    keyIngredients: [
      {
        ...
        notes: 'Neutrazen™ Pro : apaise et limite les médiateurs inflammatoires',
      },
      {
        slug: INGREDIENT_SLUGS.ASIATICOSIDE,
        notes: 'Calmactiv (Centella) : combat les signes de rosacée',
      },
      {
        slug: INGREDIENT_SLUGS.HYALURONIC_ACID,
        notes: 'Acide hyaluronique 450 kDa : renforce les défenses naturelles',
      },
