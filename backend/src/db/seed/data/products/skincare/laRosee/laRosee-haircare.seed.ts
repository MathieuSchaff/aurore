...
export const LA_ROSEE_HAIRCARE_SEED: UnifiedProductSeed[] = [
  {
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/la-rosee-flacon-vide-verre-rechargeable-pour-shampoing.webp',
    tags: {
      primary: ['shampooing'],
      secondary: [],
      avoid: [],
  ...
  },
  {
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/la-rosee-recharge-masque-capillaire-reparateur.webp',
    tags: {
