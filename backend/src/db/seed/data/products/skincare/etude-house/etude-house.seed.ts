...
export const ETUDE_HOUSE_SEED: UnifiedProductSeed[] = [
  {
    ...
    priceCents: 0,
    description:
      'Crème barrière ultra-hydratante qui renforce la fonction protectrice de la peau et apaise les irritations.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème matifiante et régulatrice qui resserre les pores dilatés et équilibre la production de sébum.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Base de teint floutante avec protection solaire SPF33 PA++ qui lisse le grain de peau et unifie le teint.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème solaire haute protection SPF50 apaisante qui protège et hydrate les peaux sensibles sans résidu blanc.',
    notes:
      'Actifs : Madecassoside, Centella Asiatica et Panthénol. Idéale pour les peaux sensibles et réactives cherchant une protection solaire tolérée.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Gel exfoliant doux aux AHA qui élimine les cellules mortes et révèle un teint plus lumineux et homogène.',
    notes:
      'Actifs : Acide Lactique, Urée, Acide de Canne à Sucre et extraits de Myrtille et Citron. Idéal pour les peaux ternes cherchant à affiner leur grain de peau.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème raffermissante au collagène qui repulpe et restructure la peau pour un effet rebondi et visiblement plus jeune.',
    notes:
      'Actifs : Collagène Hydrolysé, Protéine de Lupin et Tocophérol. Idéale pour les peaux matures ou manquant de tonicité.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Nettoyant mousse à pH légèrement acide qui nettoie en douceur sans altérer le microbiome cutané.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Baume cicatrisant concentré qui répare la barrière cutanée endommagée et calme les rougeurs et irritations.',
    notes:
      'Actifs : Madecassoside, Panthénol et Squalane. Idéal pour les peaux très sensibles, intolérantes ou en phase de récupération post-traitement.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/1D8F6052DD3FED/large_1650724200.png?1650724200',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.APAISANT, TAG_SLUGS.ANTI_ROUGEURS],
      secondary: [TAG_SLUGS.SANS_PARFUM, TAG_SLUGS.PEAU_SENSIBLE],
      avoid: [],
    },
    keyIngredients: [{ slug: INGREDIENT_SLUGS.PANTHENOL }, { slug: INGREDIENT_SLUGS.SQUALANE }],
  },
  {
    ...
    priceCents: 0,
    description:
      'Émulsion légère et hydratante qui apporte confort et souplesse sans alourdir les peaux sensibles.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème nourrissante intensive qui restaure en profondeur la barrière cutanée des peaux très sèches et fragilisées.',
    notes:
