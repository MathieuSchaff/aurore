...
export const DR_IDRISS_SEED: UnifiedProductSeed[] = [
  {
    ...
    priceCents: 4500,
    description:
      'Premier rouleau facial actif anti-rougeurs et dégonflant, soulage les rougeurs transitoires et minimise les poches sous-oculaires.',
    notes:
      'Testé cliniquement, sans parfum et non irritant. Contient arnica pour réduire les gonflements et centella asiatica pour soulager les rougeurs.',
  ...
  },
  {
    ...
    priceCents: 8000,
    description:
      'Sérum illuminant qui aide à estomper les taches brunes tenaces et améliore le teint inégal.',
    notes:
      'Livré avec deux cartouches pour assurer la fraîcheur des actifs. Sans parfum et non irritant.',
  ...
  },
  {
    ...
    priceCents: 6900,
    description:
      'Sceau actif formulé avec de la vitamine C estérifiée pour estomper la décoloration et réduire les ridules.',
  ...
  },
  {
    ...
    notes:
      'Texture légère en nuage avec un fini glow naturel sans blancheur. Contient hexylrésorcinol et céramides.',
