...
export const TOPICREM_SEED: UnifiedProductSeed[] = [
  {
    slug: 'topicrem-ultra-hydratant-huile-de-douche',
    name: 'Ultra Hydratant Huile de Douche',
    brand: 'Topicrem',
    kind: 'body-wash',
    unit: 'bottle',
    totalAmount: 1,
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/topicrem-ultra-hydratant-huile-de-douche.webp',
    tags: {
      primary: ['hydratation'],
    ...
    keyIngredients: [
      {
        ...
        concentrationUnit: '%',
        notes: `Concentration modérée adaptée à l'usage corporel quotidien. Exfoliation douce + hydratation.`,
      },
      {
        slug: INGREDIENT_SLUGS.CIRE_ABEILLE,
        notes: `Cire d'abeille émolliente et protectrice. Restaure le film hydrolipidique des peaux extra-sèches.`,
      },
      {
        slug: INGREDIENT_SLUGS.CETEARYL_ALCOHOL,
        notes:
          'Alcool gras émollient et émulsifiant. Contribue à la texture riche et nourrissante.',
      },
      {
...

  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.UREA,
        notes: 'Urée à concentration modérée. Hydratation et exfoliation douce visage.',
      },
      {
  ...
  {
    slug: 'topicrem-ultra-hydratant-huile-de-douche-1l-281616',
    name: 'Topicrem Ultra Hydratant Huile de Douche 1L',
    brand: 'Topicrem',
    kind: 'body-wash',
    unit: 'pump',
    totalAmount: 1,
