...
export const PREQUEL_SEED: UnifiedProductSeed[] = [
    ...
    keyIngredients: [
      {
        ...
        notes: 'Antiseptique doux, anti-bactérien, apaisant',
      },
    ],
  },
  {
    ...
    keyIngredients: [
      {
        ...
        notes: 'Humectant préservant le film hydrolipidique post-nettoyage',
      },
      {
        slug: INGREDIENT_SLUGS.GLYCERYL_GLUCOSIDE,
        notes: 'Humectant, renforce la barrière cutanée',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Une crème barrière hautement concentrée pour protéger et apaiser les peaux réactives.',
    ...
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.UREA, notes: 'Humectant kératolytique doux' },
      {
        ...
        notes: `Humectant puissant, améliore l'élasticité`,
      },
    ],
  },
  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.GLYCERIN,
        notes: `Humectant intensif – préserve l'hydratation pendant le nettoyage`,
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Un lait corporel hautement hydratant conçu pour lisser et réparer les peaux très sèches.',
    notes:
    ...
    keyIngredients: [
      ...
      },
      {
        ...
        notes: 'Beurre de karité – nourrit et protège la barrière',
      },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Une lotion protectrice formant un gant invisible pour préserver les mains des agressions extérieures.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Acide hyaluronique – hydratation en profondeur',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Un hydratant polyvalent haute performance pour restaurer la barrière cutanée jour et nuit.',
    ...
    keyIngredients: [
      {
        ...
        notes: 'Complexe céramides (NP, AP, EOP, NS) – restaure la barrière',
      },
      {
        slug: INGREDIENT_SLUGS.SQUALANE,
        notes: 'Émollient stable, nourrit sans obstruer les pores',
      },
      { slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE, notes: 'Hydratation en profondeur' },
      {
        slug: INGREDIENT_SLUGS.LINOLEIC_ACID,
        notes: 'Acide gras essentiel, renforce le film lipidique',
      },
    ],
  },
  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CERAMIDE_NP,
        notes: 'Complexe céramides – renforce la barrière lipidique',
      },
    ...
    keyIngredients: [
      {
        ...
        notes: 'AHA – exfoliant puissant, stimule le renouvellement cellulaire',
      },
      { slug: INGREDIENT_SLUGS.LACTIC_ACID, notes: 'AHA doux + humectant' },
      {
        slug: INGREDIENT_SLUGS.MANDELIC_ACID,
        notes: 'AHA doux, antibactérien, bien toléré peaux sensibles',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Une huile nettoyante pré-soin pour dissoudre efficacement le maquillage et les impuretés solaires.',
    ...
    keyIngredients: [
      ...
      {
        slug: INGREDIENT_SLUGS.LINOLEIC_ACID,
        notes: 'Acide gras essentiel, préserve la barrière lipidique',
      },
      {
        slug: INGREDIENT_SLUGS.HUILE_GRAINES_TOURNESOL,
        notes: 'Riche en acide linoléique, légère et nettoyante',
      },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Un baume réparateur polyvalent pour protéger les zones sèches et renforcer le film hydrolipidique.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Un sérum antioxydant puissant à la vitamine C pour illuminer le teint et corriger les taches.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Acide ascorbique pur – éclaircissant, antioxydant puissant',
      },
      {
        slug: INGREDIENT_SLUGS.FERULIC_ACID,
        notes: 'Antioxydant, stabilise et potentialise la vitamine C',
      },
    ...
    keyIngredients: [
      {
        ...
        notes: `Occlusif inerte – scelle l'hydratation, protège la barrière`,
      },
    ...
    keyIngredients: [
      {
        ...
        notes: 'BHA – exfoliant pénétrant dans les pores, antibactérien',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Un gel protecteur léger conçu pour apaiser et isoler les peaux fragilisées par le quotidien.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Anti-taches, séborégulateur, renforce la barrière',
      },
    ...
    keyIngredients: [
      {
        ...
        notes: `Super-humectant, capacité de rétention supérieure à l'acide hyaluronique`,
      },
  ...
  },
  {
    ...
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.BETA_GLUCAN, notes: 'Apaisant, immunomodulateur, anti-rougeurs' },
      {
        ...
        notes: 'Apaisant issu de camomille, calme les irritations',
      },
