...
export const SAUGELLA_SEED: UnifiedProductSeed[] = [
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/saugella-dermoliquide-soin-lavant-hygiene-intime-femmes-sauge-flacon.webp',
    tags: {
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/saugella-dermoliquide-soin-lavant-hygiene-intime-femmes-sauge.webp',
    tags: {
      primary: ['exfoliation', 'barriere-cutanee', 'hydratation'],
      secondary: [
        'keratolytique',
  ...
  },
  {
    ...
    imageUrl: 'https://aurore-cdn.b-cdn.net/products/saugella-homme-soin-lavant-intime-et-corps-special-hygiene-masculine.webp',
    tags: {
