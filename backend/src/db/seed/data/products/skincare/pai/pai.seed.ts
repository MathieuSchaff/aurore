...
export const PAI_SEED: UnifiedProductSeed[] = [
...

  {
    ...
    priceCents: 0,
    description:
      'Huile régénérante à la rose musquée qui nourrit intensément la peau et atténue les imperfections et cicatrices.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Rosa Canina Seed & Fruit Extract — régénérant, cicatrisant, riche en vitamine A/C',
      },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème de jour apaisante à la camomille et à la rose musquée qui calme les rougeurs et hydrate les peaux sensibles.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Nettoyant doux crémeux à la Camélia et à la Rose qui élimine les impuretés sans agresser la barrière cutanée.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Huile sèche bio-régénérante à la rose musquée en édition limitée, qui répare et illumine le teint fatigué.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème de jour anti-rougeurs formulée pour les peaux hypersensibles, alliant camomille calmante et rose musquée réparatrice.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum revitalisant pour peaux sensibles qui illumine, repulpe et renforce la barrière cutanée fragilisée.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum contour des yeux rafraîchissant à la Schisandra et aux céramides qui dégonfle, hydrate et renforce la peau délicate du regard.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Sodium Hyaluronate — repulpant / hydratant',
      },
      {
        slug: INGREDIENT_SLUGS.CERAMIDES,
        notes: 'Glycosphingolipides — barrière lipidique contour yeux',
      },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Kit double nettoyage formulé pour éliminer en douceur maquillage et impuretés tout en préservant le microbiome cutané.',
    notes:
...

  {
    ...
    priceCents: 0,
    description:
      'Sérum haute concentration en Acide Hyaluronique multi-poids qui repulpe, lisse et hydrate en profondeur pour un effet plumpé immédiat.',
    notes:
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.HYALURONIC_ACID,
        notes: '4 formes HA — hydratation multi-profondeur',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum défense cutanée à 10 % de Niacinamide et Cuivre Tripeptide-1 qui resserre les pores, unifie le teint et renforce la résistance de la peau.',
    notes:
...

  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.ROSEHIP_SEED_OIL,
        notes: 'Régénérant, riche en acides gras essentiels',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum visage antioxydant et nourrissant enrichi en DMAE, CoQ10 et Vitamine C pour raffermir et protéger la peau contre le vieillissement.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Correcteur rides rapide associant Rétinol, Bakuchiol et peptides pour atténuer visiblement les ridules et rides installées tout en unissant le teint.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Vitamine A pure — anti-âge, renouvellement cellulaire',
      },
      {
        slug: INGREDIENT_SLUGS.BAKUCHIOL,
        notes: 'Alternative naturelle au rétinol, anti-âge doux',
      },
      { slug: INGREDIENT_SLUGS.NIACINAMIDE, notes: 'Unification teint, anti-taches' },
      {
        slug: INGREDIENT_SLUGS.VITAMIN_C,
        notes: 'Sodium Ascorbyl Phosphate + Tetrahexyldecyl Ascorbate',
      },
    ],
  },
  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.HYALURONIC_ACID,
        notes: 'Sodium Hyaluronate — hydratation pendant le nettoyage',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Traitement anti-imperfections étape 2 à base de Benzoyl Peroxide qui élimine les bactéries et réduit les lésions acnéiques actives.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Humectant + kératolytique, ramollissement des callosités',
      },
    ],
  },
...

  {
    ...
    priceCents: 0,
    description:
      'Crème hydratante éclat enrichie en Acide Hyaluronique, Céramides et extraits botaniques qui unifie le teint et ressource la peau en profondeur.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème contour des yeux super hydratante avec peptides et antioxydants qui combat les cernes, réduit les poches et lisse les ridules de fatigue.',
    notes:
    ...
    keyIngredients: [
      ...
      {
        slug: INGREDIENT_SLUGS.VITAMIN_C,
        notes: 'Magnésium Ascorbyl Phosphate — éclat, anti-oxydant',
      },
