...
export const COSRX_SEED: UnifiedProductSeed[] = [
    ...
    keyIngredients: [
      {
        ...
        notes: 'Betaine salicylate (BHA végétal) – exfoliant doux, anti-acné',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Eau micellaire à faible pH avec niacinamide, zinc PCA et madecassoside pour un démaquillage doux.',
    notes:
      'Pas de rinçage nécessaire, convient peaux sensibles. Le zinc PCA aide à réguler le sébum.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/860B4E06486479/large_1720418298.png?1720418298',
    tags: {
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/1E8C01C78AB0E7/large_1650540029.png?1650540029',
    tags: {
    ...
    keyIngredients: [
      {
        ...
        notes: `Filtrat de mucine d'escargot – actif signature`,
      },
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/F686EFE1BC049B/large_1720428399.png?1720428399',
    tags: {
    ...
    keyIngredients: [
      {
        ...
        notes: 'Triple HA : libre, hydrolysé, crosspolymère',
      },
      { slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE },
      { slug: INGREDIENT_SLUGS.PANTHENOL },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Premier nettoyant texture lait-gel à faible pH, idéal pour retirer maquillage léger et SPF.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Mousse nettoyante avec acide salicylique et complexe Centella, formulée pour les peaux acnéiques.',
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-ac-collection-calming-foam-cleanser.webp',
    tags: {
      primary: [TAG_SLUGS.ANTI_ACNE],
      secondary: [
        TAG_SLUGS.MOUSSE_NETTOYANTE,
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SALICYLIC_ACID,
        notes: 'BHA classique – anti-acné, décongestionne les pores',
      },
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Complexe : asiaticoside, acides triterpéniques',
      },
      { slug: INGREDIENT_SLUGS.MADECASSOSIDE },
      { slug: INGREDIENT_SLUGS.MADECASSIC_ACID },
    ],
  },
  {
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-salicylic-acid-daily-gentle-cleanser.webp',
    tags: {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SALICYLIC_ACID,
        notes: 'BHA – exfoliation douce quotidienne, pores',
      },
      { slug: INGREDIENT_SLUGS.GLYCERIN },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Baume nettoyant enrichi en complexe Centella, fond au toucher et élimine maquillage et impuretés.',
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Complexe complet : extrait, leaf, root + madecassoside',
      },
      { slug: INGREDIENT_SLUGS.MADECASSOSIDE },
      { slug: INGREDIENT_SLUGS.MADECASSIC_ACID },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique exfoliant double acide (glycolique + betaine salicylate) pour affiner le grain et uniformiser.',
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/DCB42D7355E6AB/large_1738922670.png?1738922670',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.TONIQUE,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique au propolis et extrait de miel, nourrissant et apaisant pour peaux sèches et sensibles.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique apaisant au complexe Centella complet (madecassoside, asiaticoside, acide madécassique, acide asiatique).',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique quotidien avec vitamine C stable (ascorbyl glucoside), BHA/AHA léger et niacinamide.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Essence légère à 95% de galactomyces ferment filtrate, équilibrante, hydratante et éclaircissante.',
    notes:
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-galactomyces-95-tone-balancing-essence.webp',
    tags: {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.NIACINAMIDE,
        notes: 'Soutien éclaircissant en complément du galactomyces',
      },
  ...
  },
  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Actif principal – apaisant et réparateur',
      },
      { slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE },
      { slug: INGREDIENT_SLUGS.PANTHENOL },
      { slug: INGREDIENT_SLUGS.BETAINE },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Solution exfoliante BHA/AHA avec propolis et arbre à thé pour nettoyer les pores et affiner le grain.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique liquide apaisant et légèrement exfoliant (BHA + PHA gluconolactone) pour peaux acnéiques.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Liquide exfoliant au betaine salicylate (BHA naturel) pour décongestionner les pores et réduire les comédons.',
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SALICYLIC_ACID,
        notes: 'Betaine salicylate – BHA végétal, actif principal',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Liquide exfoliant AHA (acide glycolique 7%) pour éliminer les comédons blancs et affiner le grain.',
    ...
    keyIngredients: [
      {
        ...
        notes: 'AHA 7% – exfoliation efficace des comédons',
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/06301E605A2071/large_1721473235.png?1721473235',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.ESSENCE,
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE,
        notes: 'Actif principal – hydratation immédiate',
      },
      { slug: INGREDIENT_SLUGS.PANTHENOL },
      { slug: INGREDIENT_SLUGS.GLYCERIN },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Pads toner apaisants multi-actifs (centella, thé vert, PHA lactobionique) pour calmer et exfolier en douceur.',
    notes:
      'Exfoliation chimique douce + apaisement en une étape. Contient menthyl lactate, effet fraîcheur.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/BFF3F8A34F0189/large_1570378651.png?1570378651',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Pads toner hydratants (triple HA + BHA + PHA) pour hydrater et exfolier légèrement en une étape.',
    notes:
      'Très polyvalents, conviennent peaux normales à sèches. Contenu liquide : 140 mL environ.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/15257DCDA1D48F/large_1730092007.png?1730092007',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.EXFOLIATION,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum concentré à 15% de niacinamide, acétyl glucosamine et zinc PCA pour taches et sébum.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum booster à 6 peptides (copper tripeptide-1, palmitoyl tripeptide-8, acetyl hexapeptide-8) pour fermeté.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/E18A6CB400B11D/large_1744884915.png?1744884915',
    tags: {
    ...
    keyIngredients: [
      {
        ...
        notes: 'Copper tripeptide-1 – réparation et anti-âge',
      },
      {
        slug: INGREDIENT_SLUGS.PALMITOYL_TRIPEPTIDE_1,
        notes: 'Matrixyl® composant – synthèse collagène',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum multi-hyaluronique avec céramide NP et acides aminés pour hydratation ciblée et renfort barrière.',
    notes:
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/AD9DC937E378D2/large_1717222826.png?1717222826',
    tags: {
      primary: [TAG_SLUGS.ECLAT, TAG_SLUGS.ANTI_TACHES],
      secondary: [
        TAG_SLUGS.SERUM,
    ...
    keyIngredients: [
      {
        ...
        notes: 'acide ascorbique pur – éclat intense',
        concentrationValue: 23,
        concentrationUnit: '%',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum à 13% de 3-O-éthyl ascorbique avec glutathion et niacinamide pour uniformiser le teint.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum huileux à 0.5% de rétinol pur avec squalane et tocotriénols pour un anti-âge avancé.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'rétinol pur, formule anhydre',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Liquide pores-minimiseurs double action (BHA + PHA) avec extraits apaisants pour affiner le grain.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum concentré vitamine C pure (ascorbic acid) avec acide glycolique et chokeberry pour éclat intense.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum exfoliant double acide (glycolique 2% + salicylique 2%) avec PHA gluconolactone pour imperfections.',
    notes:
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-aha-2-bha-2-blemish-treatment-serum.webp',
    tags: {
      primary: [TAG_SLUGS.ANTI_ACNE, TAG_SLUGS.GRAIN_PEAU],
      secondary: [
        TAG_SLUGS.SERUM,
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.GLYCOLIC_ACID,
        notes: 'AHA 2% – exfoliation de surface',
        concentrationValue: 2,
        concentrationUnit: '%',
      },
      {
        slug: INGREDIENT_SLUGS.SALICYLIC_ACID,
        notes: 'pores et anti-acné',
        concentrationValue: 2,
        concentrationUnit: '%',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Ampoule triple HA avec PHA (lactobionic acid) pour une hydratation intensive et un effet lissant.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum anti-taches complet : alpha-arbutine 2%, acide tranexamique 3%, niacinamide 5% et madecassoside.',
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-alpha-arbutin-2-discoloration-care-serum.webp',
    tags: {
    ...
    keyIngredients: [
      ...
      },
      {
        ...
        notes: 'anti-taches et anti-inflammatoire',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Ampoule au panthenol (B5) et triple HA pour calmer les peaux irritées ou après procédures.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/1CD6E5D0694A47/large_1672826717.jpeg?1672826717',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum Cica léger avec Centella Asiatica complet (madecassoside, asiaticoside, acide madécassique) pour apaiser.',
    notes:
  ...
  },
  {
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-advanced-snail-radiance-dual-essence.webp',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Essence à 95% de galactomyces ferment pour uniformiser le teint et affiner la texture cutanée.',
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-galactomyces-95-whitening-power-essence.webp',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème riche au miel et céramide 3 (NP) pour une hydratation intense des peaux sèches.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème légère au propolis, miel et royal jelly extract pour nourrir et protéger sans lourdeur.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème barrière avec 5 céramides (NP, AP, EOP, AS, NS), cholestérol et phytosphingosine, formule biomimétique.',
    notes:
      'Une des meilleures formules céramide de la marque. Idéal pour eczéma, barrière altérée, peaux atopiques.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/2C02ABAF125C62/large_1744700990.png?1744700990',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème légère apaisante à la niacinamide, propolis et zinc PCA, équilibrante pour peaux mixtes.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème hydratante intensive au sodium hyaluronate avec huiles de macadamia et sea-buckthorn.',
    notes:
      'Bonne hydratation occlusive, texture classique et confortable. Peaux normales à sèches.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/DFA43C37F45D2A/large_1655978104.png?1655978104',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.CREME_HYDRATANTE,
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE,
        notes: 'Actif principal – hydratation intensive',
      },
      { slug: INGREDIENT_SLUGS.PANTHENOL },
      { slug: INGREDIENT_SLUGS.GLYCERIN },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Gel-crème apaisant au thé vert, léger et frais, idéal pour peaux mixtes ou sensibles.',
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-hydrium-green-tea-aqua-soothing-gel-cream.webp',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème riche aux céramides NP, propolis et triple HA pour nourrir et renforcer les peaux sèches et sensibles.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/983C7EC0C79DA9/large_1737538521.png?1737538521',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.CREME_HYDRATANTE,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Gel-crème céramide 5-complex avec Centella, texture fraîche pour les peaux réactives ou après-soleil.',
    notes:
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-comfort-cool-ceramide-soothing-gel-cream.webp',
    tags: {
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/446495248817C1/large_1724996412.png?1724996412',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.LOTION,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème réparatrice au panthenol (B5) et triple acide hyaluronique pour peaux déshydratées ou sensibilisées.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/A6F60FC05411F9/large_1621407303.png?1621407303',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.CREME_HYDRATANTE,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème quotidienne multifonction avec AHA/BHA, vitamine C stable (ascorbyl glucoside) et alpha-arbutine.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque de nuit au riz et niacinamide pour nourrir, régénérer et illuminer le teint pendant le sommeil.',
    notes:
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-ultimate-nourishing-rice-overnight-mask.webp',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème rétinol 0.1% avec céramides, shea butter et vitamine C, pour débuter avec le rétinol en douceur.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème spot anti-imperfection avec zinc oxide, Centella et arbre à thé pour traiter les boutons.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème contour des yeux nourrissante au miel, céramide 3 et oligopeptide-1 (EGF) pour hydrater.',
  ...
  },
  {
    ...
    keyIngredients: [{ slug: INGREDIENT_SLUGS.GLYCERIN }, { slug: INGREDIENT_SLUGS.PANTHENOL }],
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque tissu apaisant au complexe Centella pour calmer les rougeurs et renforcer la barrière.',
  ...
  },
  {
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/ACF54C8968ED2A/large_1718449862.png?1718449862',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque hydrogel anti-âge avec collagène hydrolysé, céramide 5-complex et multi-peptides.',
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-the-peptide-collagen-lifting-glow-hydrogel-face-mask.webp',
    tags: {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque tissu triple HA avec Centella pour une hydratation intensive en 15 minutes.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/4DB5A2A092F256/large_1747890098.png?1747890098',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION],
      secondary: [
        TAG_SLUGS.MASQUE_TISSU,
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE,
        notes: 'Hydrolysé + sodium acetylated hyaluronate',
      },
      { slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA },
      { slug: INGREDIENT_SLUGS.PANTHENOL },
    ],
  },
  {
    ...
    priceCents: 0,
    description:
      'Gel exfoliant doux du soir avec PHA (lactobionic acid), papain et niacinamide pour affiner sans agresser.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Baume lèvres de nuit aux céramides NP, beurre de karité et jojoba pour réparer les lèvres.',
    ...
    imageUrl:
      'https://cdn1.skinsafeproducts.com/photo/88EE790BB93EB3/large_1656312708.png?1656312708',
    tags: {
      primary: [TAG_SLUGS.BARRIERE_CUTANEE],
      secondary: [
        TAG_SLUGS.BAUME,
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Baume lèvres de nuit au propolis, miel et royal jelly extract, réparateur et nourrissant.',
    notes:
    ...
    imageUrl:
      'https://aurore-cdn.b-cdn.net/products/cosrx-lip-sleep-propolis-lip-sleeping-mask.webp',
    tags: {
      primary: [TAG_SLUGS.DESHYDRATATION, TAG_SLUGS.PEAU_SECHE],
      secondary: [TAG_SLUGS.BAUME, TAG_SLUGS.SOIR, TAG_SLUGS.ZONE_LEVRES],
      avoid: [],
    },
    keyIngredients: [{ slug: INGREDIENT_SLUGS.TOCOPHEROL }, { slug: INGREDIENT_SLUGS.GLYCERIN }],
  },
  {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème spot à Centella Asiatica, zinc oxide et zinc PCA pour traiter les imperfections et rougeurs localisées.',
    notes:
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Actif principal – apaisant anti-imperfections',
      },
      { slug: INGREDIENT_SLUGS.ZINC_PCA, notes: 'Séborégulateur' },
      { slug: INGREDIENT_SLUGS.GLYCERIN },
    ],
