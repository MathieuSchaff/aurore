...
export const MIXSOON_SEED: UnifiedProductSeed[] = [
  {
    ...
    priceCents: 0,
    description:
      'Crème réparatrice enrichie en Bifida Ferment Lysate pour renforcer la barrière cutanée et prévenir le vieillissement.',
    notes:
    ...
    keyIngredients: [{ slug: INGREDIENT_SLUGS.POSTBIOTICS }, { slug: INGREDIENT_SLUGS.SQUALANE }],
  },
  {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Toner apaisant à la Centella Asiatica pour calmer les rougeurs et préparer la peau aux soins suivants.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Huile démaquillante fermentée aux extraits de soja pour dissoudre maquillage et impuretés sans altérer le film hydrolipidique.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème fermentée aux actifs botaniques pour nourrir la peau en profondeur et lui apporter éclat et confort durable.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Essence concentrée aux ferments de soja, poire et grenade pour régénérer la peau et restaurer son éclat naturel.',
    notes:
      'Actifs clés : Lactobacillus/Soybean Ferment, Saccharomyces/Barley Ferment, Glycérine. Idéal pour toutes peaux.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Essence ultra-légère à la Centella Asiatica pour apaiser les peaux irritées et réduire les rougeurs au quotidien.',
    notes:
      'Actifs clés : Centella Asiatica Extract, Butylene Glycol. Idéal pour peaux sensibles et réactives.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Pads toniques à la Centella Asiatica pour apaiser, hydrater et préparer la peau en un geste pratique.',
    notes:
      'Actifs clés : Centella Asiatica Extract, Allantoin, Tocopherol. Idéal pour peaux sensibles et mixtes.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Eau nettoyante douce à la Centella pour démaquiller et purifier sans agresser les peaux fragilisées.',
    notes:
      'Actifs clés : Centella Asiatica Extract, Allantoin, Panthénol, Houttuynia Cordata. Idéal pour peaux sensibles.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque tissu à la Centella Asiatica pour apaiser les irritations, réduire les rougeurs et restaurer le confort cutané.',
    notes:
      'Actifs clés : Centella Asiatica Extract, Allantoin, Glycérine. Idéal pour peaux sensibles, réactives ou après exposition.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque pad au lait de soja enrichi en céramides et Madecassoside pour nourrir intensément et renforcer la barrière cutanée.',
    notes:
      'Actifs clés : Ceramide NP, Madecassoside, Hyaluronate, Centella, Tea Tree. Idéal pour peaux sèches et sensibles.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Masque tissu au Bifida Ferment Lysate pour revitaliser la barrière cutanée et redonner éclat et souplesse à la peau.',
    notes:
      'Actifs clés : Bifida Ferment Lysate, Sodium Hyaluronate, Panthénol. Idéal pour peaux fatiguées et sensibles.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Pads toniques au Galactomyces et Niacinamide pour affiner le grain de peau, unifier le teint et réduire les pores.',
    notes:
      'Actifs clés : Galactomyces Ferment Filtrate, Niacinamide, Tocopherol. Idéal pour peaux mixtes à pores dilatés.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum lait de soja multi-actifs aux peptides et céramides pour lisser, unifier et régénérer la peau en profondeur.',
    notes:
  ...
  },
  {
    ...
    notes:
      'Actifs clés : Aloe Barbadensis, Hydrolyzed Hyaluronic Acid, Mentha Arvensis, Panthénol. Idéal pour peaux réactives après exposition.',
  ...
  },
  {
    ...
    notes:
      'Actifs clés : Centella Asiatica Extract, Salicylic Acid, Glycérine. Idéal pour peaux mixtes à grasses sujettes aux imperfections.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Pads toniques aux extraits de légumineuses fermentées pour hydrater, raffermir et unifier le teint en un geste.',
    notes:
      'Actifs clés : Soybean Extract, Niacinamide, Adénosine, Sodium Hyaluronate. Idéal pour peaux normales à mixtes.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Essence minimaliste à la fleur de Bellis Perennis (Marguerite) pour éclaircir le teint et unifier les taches pigmentaires.',
    notes:
      'Actifs clés : Bellis Perennis Flower Extract, Butylene Glycol. Idéal pour peaux ternes sujettes aux irrégularités de teint.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Toner bi-ingrédient au Galactomyces Ferment Filtrate pour purifier, affiner les pores et illuminer le teint durablement.',
    notes:
