...
export const BIOLANE_ATIDA_SEED: UnifiedProductSeed[] = [
  {
    slug: 'biolane-gel-lavant-corps-et-cheveux-peaux-sensibles-cheveux-fins-bebe',
    name: 'Gel Lavant Corps Et Cheveux Peaux Sensibles Cheveux Fins Bébé',
    brand: 'Biolane',
    kind: 'body-wash',
    unit: 'bottle',
    totalAmount: 750,
