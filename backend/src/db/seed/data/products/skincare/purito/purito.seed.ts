...
export const PURITO_SEED: UnifiedProductSeed[] = [
  {
    ...
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.NIACINAMIDE, notes: 'Unification teint, sébo-régulation' },
      {
        ...
        notes: 'Sodium Hyaluronate — hydratation de surface',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème contour des yeux nourrissante à base de Centella Asiatica pour atténuer les signes de fatigue et lisser les ridules.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum multi-actifs à la Centella Asiatica pour apaiser, renforcer et unifier le teint en une seule étape.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Sérum apaisant sans parfum formulé à la Centella Asiatica pour calmer les rougeurs et soutenir la barrière cutanée.',
    notes:
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème contour des yeux apaisante et régénérante enrichie en Centella Asiatica et peptides anti-âge.',
    notes:
  ...
  },
  {
    ...
    keyIngredients: [
      ...
      {
        slug: INGREDIENT_SLUGS.HYALURONIC_ACID,
        notes: 'Sodium Hyaluronate Crosspolymer — rétention hydrique',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème barrière enrichie en céramides et en lipides pour restaurer durablement la fonction protectrice de la peau.',
    notes:
    ...
    keyIngredients: [
      {
        ...
        notes: 'Bifida Ferment Lysate + Lactobacillus fermentés — microbiome / éclat',
      },
      { slug: INGREDIENT_SLUGS.NIACINAMIDE, notes: 'Unification teint, sébo-régulation' },
  ...
  },
  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.HYALURONIC_ACID,
        notes: 'Triple HA : Hydrolysé, Sodium Hyaluronate, Sodium Acétylated Hyaluronate',
      },
      { slug: INGREDIENT_SLUGS.PANTHENOL, notes: 'Apaisant / hydratant complémentaire' },
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Madecassoside + Asiaticoside — apaisant',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Crème réparatrice riche à la Centella Asiatica pour accélérer la cicatrisation, calmer les irritations et nourrir intensément la peau.',
    notes:
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Madecassoside + Asiaticoside, cicatrisant / apaisant',
      },
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Huile nettoyante végétale qui fond au contact de la peau pour éliminer en douceur impuretés et maquillage résistant.',
  ...
  },
  {
    ...
    priceCents: 0,
    description:
      'Tonique sans parfum à la Centella Asiatica pour apaiser instantanément les rougeurs et préparer la peau aux soins suivants.',
    notes:
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.CENTELLA_ASIATICA,
        notes: 'Madecassoside + Asiaticoside, apaisant / anti-rougeurs',
      },
      { slug: INGREDIENT_SLUGS.HYALURONIC_ACID, notes: 'Sodium Hyaluronate — hydratation' },
      { slug: INGREDIENT_SLUGS.PANTHENOL, notes: 'Apaisant / hydratant' },
    ],
...

  {
    ...
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.KOJIC_ACID, notes: 'Éclaircissant puissant (pigmentation)' },
      {
        ...
        notes:
          'Tea Tree (eau + huile) – antibactérien, séborégulateur (attention irritant post-IPL)',
      },
