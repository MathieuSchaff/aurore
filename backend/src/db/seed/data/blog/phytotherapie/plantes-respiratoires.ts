...
| Symptôme | Plantes de 1ʳᵉ intention |
|---|---|
| **Toux sèche irritative** | Guimauve + plantain |
| **Toux grasse / bronchite** | Primevère + lierre (sirop) |
| **Bronchite chronique / terrain** | Ortie (cure de fond) |
| **Mal de gorge** | Guimauve, plantain, réglisse |
...
| Plante | Toux sèche | Toux grasse | Bronchite | Enfants | Preuves cliniques |
|---|---|---|---|---|---|
| **Guimauve** | +++ | + | ++ | Oui | Modérées (tradition + pharmacopée) |
| **Plantain** | +++ | +++ | ++ | Oui | Modérées (pharmacopée) |
| **Primevère** | + | +++ | +++ | Prudence | Bonnes (extraits standardisés) |
| **Lierre** (sirop) | + | +++ | +++ | Selon produit | Solides (phytomédicaments) |
| **Ortie** | — | + | + (terrain) | Oui | Modérées |
| **Marrube blanc** | + | ++ | ++ | Prudence | Limitées |
