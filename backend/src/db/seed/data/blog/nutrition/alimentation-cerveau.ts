...
*Sources* : œufs, saumon, noix, graines, bananes, légumes verts à feuilles. Des glucides complexes facilitent son passage cérébral en abaissant la compétition des autres acides aminés au transporteur de la barrière hémato-encéphalique.

**Tyrosine** → précurseur de la dopamine et de la noradrénaline.
*Sources* : volaille, œufs, poissons, amandes, avocat, graines de soja.
...
1. **Poissons gras** (saumon, maquereau, sardines) — oméga-3, myéline, BDNF.
2. **Myrtilles** — anthocyanes, circulation, BDNF.
3. **Légumes verts à feuilles** — vitamines B, magnésium, folate, nitrates.
4. **Œufs** — choline, vitamines B, cholestérol (myéline).
5. **Noix de Grenoble** — oméga-3 ALA, polyphénols, vitamine E.
6. **Curcuma** — curcumine, BDNF, anti-inflammatoire.
7. **Chocolat noir 70 %+** — flavanols, circulation, antioxydants.
8. **Thé vert** — EGCG, L-théanine, polyphénols.
9. **Huile d'olive extra-vierge** — polyphénols, oléocanthal.
10. **Avocat** — graisses monoinsaturées, vitamine E, glutathion.

## Pour aller plus loin

- L'article [Guide des nutriments fonctionnels](/blog/guide-nutriments-fonctionnels) détaille les nutriments individuels et leurs cibles journalières.
- L'article [Aliments pour la peau](/blog/aliments-pour-peau-guide) couvre les mêmes bases alimentaires avec un angle cutané — les recoupements sont nombreux (oméga-3, polyphénols, crucifères).
