...
export const keratosePilaire: ArticleInput = {
  ...
  slug: 'keratose-pilaire-guide-2026',
  category: 'skincare',
  excerpt:
...
| Variante | Caractéristiques | Localisation typique |
|---|---|---|
| **KP simple** | Papules couleur chair, grisâtres ou blanches, sèches et rugueuses | Bras (face externe), cuisses |
| **KP rubra** | Érythème périfolliculaire marqué, inflammation visible | Joues, bras, cou |
| **KP atrophiante** | Évolution vers alopécie et atrophie cicatricielle | Sourcils, cuir chevelu |
| **KP pigmentée** | Hyperpigmentation post-inflammatoire périfolliculaire | Tronc, membres inférieurs (phototypes foncés) |
...
| Facteur | Effet |
|---|---|
| Dermatite atopique | Association très fréquente (déficit FLG commun) |
| Puberté / adolescence | Pic d'incidence (poussées hormonales) |
| IMC élevé | Corrélation statistique avec sévérité |
| Ichtyose vulgaire | Trouble de la kératinisation concomitant |
| SOPK, puberté | Déséquilibres hormonaux déclenchants |
...
| Pathologie | Signe distinctif vs KP |
|---|---|
| Acné vulgaire | Comédons présents, nodules douloureux |
| Folliculite bactérienne | Pustule centrale, douleur, apparition soudaine |
| Lichen pilaire | Inflammation profonde, cicatrices alopéciques |
| Dermatite atopique | Plaques diffuses, prurit féroce, antécédents allergiques |
...
| Actif | Mécanisme | Concentrations | Efficacité (études 2024-2025) |
|---|---|---|---|
| **Urée** | Humectant + kératolytique (brise les ponts hydrogène de la kératine) | 10-20 % (kératolytique au-delà) | Amélioration dès 1 semaine à 20 % |
| **Acide lactique (AHA)** | Exfoliation + hydratation | 10-12 % | **−66 % des lésions en 12 semaines** (supérieur à l'acide salicylique) |
| **Acide salicylique (BHA)** | Liposoluble, pénétration intra-folliculaire | 2-6 % | ~−52 % des lésions |

### Seconde ligne — rétinoïdes et agents ciblés

- **Rétinoïdes topiques** (trétinoïne, adapalène, **trifarotène 0,005 %**) : normalisent la différenciation épithéliale. Le trifarotène (4ᵉ génération, sélectif RAR-γ) a montré des résultats prometteurs en 2025. Tolérance : érythème et sécheresse fréquents les 4 premières semaines.
...
Protocole prudent : savon/pain dermatologique au soufre (2-10 %, parfois + acide salicylique 3 %), **1-2×/semaine max**, suivi immédiatement d'une crème urée 10-20 % ou céramides. Éviter le même soir qu'un rétinoïde.
...
| Laser | Indication | Résultats |
|---|---|---|
| **Nd:YAG Q-Switched (1064 nm)** | Texture + pigmentation, phototypes foncés | Option de choix en méta-analyses 2024, profil de sécurité favorable |
| **Laser à Colorant Pulsé (PDL)** | Érythème de la KP rubra | Standard d'excellence pour la rougeur, peu d'effet sur la texture |
| **Laser Thulium (1927 nm)** | Rugosité, taches solaires associées | Non-ablatif fractionné, lissage rapide en 3 séances mensuelles (études Johns Hopkins 2025-2026) |
| **Laser CO2 fractionné** | Formes hyperkératosiques sévères | Relissage ablatif, stimulation collagène |
| **Épilation laser** | KP aggravée par le poil | Réduit les papules en éliminant le trigger initial |
...
## 11. Algorithme de traitement 2025-2026
...
3. **Options avancées** — **laser Nd:YAG** ou **Thulium 1927 nm** pour la texture, **épilation laser** si le poil est un facteur majeur.
