...
## Introduction
Tous les ingrédients ne se valent pas pour une peau rosacéique.

Certains peuvent aider à calmer, réparer ou stabiliser.
D'autres peuvent aggraver les rougeurs, les brûlures ou les flushings.

Le but n'est pas de diaboliser des ingrédients. Le vrai objectif est de comprendre :

- ce qui aide réellement, et pourquoi
- ce qui irrite souvent, et par quel mécanisme
- ce qui dépend du profil individuel ou de la concentration

**Un principe fondamental :**
La formulation compte autant que l'ingrédient. Un actif excellent dans une base irritante peut devenir problématique. Un actif modéré dans une base très bien tolérée peut être efficace. Lire la liste INCI complète est toujours plus fiable que se fier au nom commercial ou à la description marketing.

---

# 1. Ingrédients réparateurs de la barrière

Ces ingrédients ont pour rôle principal de restaurer et protéger le stratum corneum. Ils sont généralement bien tolérés et constituent la base de toute routine rosacée.
...
**Mécanisme :** Se convertit en acide pantothénique (vitamine B5) dans la peau. Stimule la prolifération et la migration des kératinocytes. Humectant, légèrement anti-inflammatoire via l'inhibition de NF-κB. Favorise la cicatrisation de l'épiderme.
...
# 2. Ingrédients actifs anti-inflammatoires et anti-rougeurs

Ces ingrédients vont au-delà de la réparation : ils agissent sur les mécanismes inflammatoires et vasculaires de la rosacée.
...
**Intérêt dans la rosacée :** apaisement, soutien de la barrière, protection vasculaire. Particulièrement intéressant dans les formes phymateuses débutantes (action sur les fibroblastes).
...
**Mécanisme :**
- stimule les récepteurs de décectine-1 sur les kératinocytes → effet immunomodulateur
...
**Intérêt dans la rosacée :** particulièrement pertinent dans les formes ETR avec progression des télangiectasies et dans la photoprotection antioxydante.
...
# 3. Ingrédients souvent problématiques

Ces ingrédients irritent fréquemment la peau rosacéique. Il ne s'agit pas d'une contre-indication absolue pour chaque individu, mais d'alertes à vérifier sur les étiquettes.

---

## Parfum / Fragrance

**INCI à repérer :** Parfum, Fragrance, et les ingrédients de la liste des 26 allergènes (Limonene, Linalool, Geraniol, Citronellol, Eugenol, Coumarin, Cinnamal, etc.)
...
Les huiles essentielles n'ont pas leur place dans un soin quotidien pour peau rosacéique.
...
**Dans la rosacée :** contre-indiqué en usage régulier.
...
# 6. Lecture rapide de la liste INCI

La liste INCI (International Nomenclature of Cosmetic Ingredients) permet d'identifier ce qu'un produit contient réellement.

**Règles de base :**
- les ingrédients sont listés par ordre décroissant de concentration jusqu'à 1 %
- en dessous de 1 %, l'ordre est libre (les actifs en faible concentration, parfums, colorants arrivent souvent en fin de liste)
- un ingrédient en 2ème ou 3ème position est présent en quantité significative ; le même ingrédient en 15ème position est présent en trace

**Signaux positifs à repérer en début de liste :**

| INCI | Signification |
|---|---|
| Aqua (Water) | Base aqueuse — neutre |
| Glycerin | Humectant de base |
| Ceramide NP / AP / EOP | Réparation barrière |
| Panthenol | Apaisant, réparateur |
| Allantoin | Soothing |
| Squalane | Emollient doux |
| Cholesterol | Réparation barrière |
| Niacinamide | Actif anti-inflammatoire/barrière |
| Sodium Hyaluronate | Humectant |
| Centella Asiatica Extract / Madecassoside | Anti-inflammatoire |

**Signaux d'alerte à repérer, quelle que soit leur position :**

| INCI | Pourquoi surveiller |
|---|---|
| Parfum / Fragrance | Irritant neurosensoriel, allergène potentiel |
| Alcohol Denat. / SD Alcohol (en tête de liste) | Déstructure la barrière |
| Sodium Lauryl Sulfate | Tensioactif trop agressif |
| Methylisothiazolinone | Sensibilisant fréquent |
| Menthol | Active TRPM8/TRPA1 → flushing retardé |
| Tout "…oil" végétal aromatique | Huile essentielle probable |
| Limonene, Linalool, Geraniol, Eugenol | Allergènes déclarés des parfums |
| Benzoyl Peroxide | Oxydant irritant, non adapté à la rosacée |

**Astuce :** pour les produits avec une longue liste INCI, se concentrer sur les 5 premiers ingrédients (qui représentent souvent 80–90 % du produit) et scanner la liste pour les signaux d'alerte listés ci-dessus, quelle que soit leur position.
