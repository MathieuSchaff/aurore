...
//
// Usage:
//   bun run backend/src/db/seed/runners/ingest-obf-brand-labels.ts                   # dry-run, cached dump
//   bun run backend/src/db/seed/runners/ingest-obf-brand-labels.ts --download        # force re-download
//   bun run backend/src/db/seed/runners/ingest-obf-brand-labels.ts --write           # apply DB upserts
//   bun run backend/src/db/seed/runners/ingest-obf-brand-labels.ts --threshold 0.7   # stricter ratio
//
