...
//
// Usage:
//   bun run backend/src/db/seed/runners/ingest-peta-cruelty-free.ts                # dry-run, cached
//   bun run backend/src/db/seed/runners/ingest-peta-cruelty-free.ts --refresh      # re-fetch all
//   bun run backend/src/db/seed/runners/ingest-peta-cruelty-free.ts --write        # apply DB upserts
//   bun run backend/src/db/seed/runners/ingest-peta-cruelty-free.ts --strict-prune # also remove stale `peta` from sources
