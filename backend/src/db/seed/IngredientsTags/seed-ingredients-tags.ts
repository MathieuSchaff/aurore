...
export const ingredientTagMap: IngredientTagMap = {
  ...
  [INGREDIENT_SLUGS.URIAGE_THERMAL_SPRING_WATER]: {
    ...
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  [INGREDIENT_SLUGS.ASPARAGOPSIS_ARMATA_EXTRACT]: {
    primary: [TAG_SLUGS.ANTI_ROUGEURS, TAG_SLUGS.APAISANT],
    secondary: [TAG_SLUGS.ROSACEE, TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.PEAU_REACTIVE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.SYMSITIVE]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.PEAU_REACTIVE],
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.HYPER_SENSIBILITE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.LICOCHALCONE_A]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.PHOTO_VIEILLISSEMENT, TAG_SLUGS.ACNE, TAG_SLUGS.PEAU_SENSIBLE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.SAMBUCUS_NIGRA]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.ADOUCISSANT],
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.CERNES_POCHES, TAG_SLUGS.PEAU_REACTIVE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.DAUCUS_CAROTA]: {
    primary: [TAG_SLUGS.ECLAT, TAG_SLUGS.APAISANT, TAG_SLUGS.ANTI_OXYDANT],
    secondary: [TAG_SLUGS.PEAU_MATURE, TAG_SLUGS.TEINT_TERNE, TAG_SLUGS.REPARATEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.MANNITOL]: {
    ...
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.PEAU_TOUS_TYPES, TAG_SLUGS.HYDRATATION_LONGUE_DUREE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.PROPANEDIOL]: {
    primary: [TAG_SLUGS.HUMECTANT],
    secondary: [TAG_SLUGS.SOLVANT, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  [INGREDIENT_SLUGS.CITRIC_ACID]: {
    primary: [TAG_SLUGS.AJUSTEUR_PH],
    secondary: [TAG_SLUGS.ANTI_OXYDANT, TAG_SLUGS.AHA],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.SODIUM_CITRATE]: {
    primary: [TAG_SLUGS.AJUSTEUR_PH, TAG_SLUGS.STABILISANT],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  [INGREDIENT_SLUGS.DISODIUM_EDTA]: {
    primary: [TAG_SLUGS.CHELATANT, TAG_SLUGS.STABILISANT],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.CARBOMER]: {
    primary: [TAG_SLUGS.GELIFIANT, TAG_SLUGS.AGENT_TEXTURE],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.CETYL_ALCOHOL]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.AGENT_TEXTURE],
    secondary: [TAG_SLUGS.ALCOOL_GRAS, TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.PEG_100_STEARATE]: {
    primary: [TAG_SLUGS.TENSIOACTIF, TAG_SLUGS.EMULSIFIANT],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.DIMETHICONOL]: {
    ...
    secondary: [TAG_SLUGS.LISSANT, TAG_SLUGS.SILICONE, TAG_SLUGS.PEAU_SECHE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.CYCLOPENTASILOXANE]: {
    primary: [TAG_SLUGS.SOLVANT, TAG_SLUGS.LISSANT],
    secondary: [TAG_SLUGS.SILICONE_VOLATIL, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.PHENYL_TRIMETHICONE]: {
    ...
    secondary: [TAG_SLUGS.SILICONE, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  [INGREDIENT_SLUGS.MINERAL_OIL]: {
    primary: [TAG_SLUGS.OCCLUSIF, TAG_SLUGS.EMOLLIENT],
    secondary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.SANS_PARFUM],
    avoid: [],
  },
  [INGREDIENT_SLUGS.PETROLATUM]: {
    primary: [TAG_SLUGS.OCCLUSIF, TAG_SLUGS.EMOLLIENT, TAG_SLUGS.PROTECTION_CUTANEE],
    secondary: [TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.PEAU_TRES_SECHE, TAG_SLUGS.SANS_PARFUM],
    avoid: [],
  },
  [INGREDIENT_SLUGS.ISOHEXADECANE]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.SOLVANT],
  ...
  [INGREDIENT_SLUGS.COCO_CAPRYLATE_CAPRATE]: {
    primary: [TAG_SLUGS.EMOLLIENT, TAG_SLUGS.ADOUCISSANT],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES, TAG_SLUGS.SANS_PARFUM],
    avoid: [],
  },
  [INGREDIENT_SLUGS.SODIUM_CHLORIDE]: {
    primary: [TAG_SLUGS.STABILISANT, TAG_SLUGS.AGENT_TEXTURE],
    secondary: [TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.TASMANNIA_LANCEOLATA]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.FLUSHS, TAG_SLUGS.TEINT_TERNE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.ENOXOLONE]: {
    primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.BARRIERE_CUTANEE, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.ROSACEE, TAG_SLUGS.BARRIERE_CUTANEE_ALTEREE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.NEUTRAZEN]: {
    primary: [TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.APAISANT, TAG_SLUGS.ANTI_ROUGEURS],
    secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.FLUSHS, TAG_SLUGS.ROSACEE],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.AVOCADO_OIL]: {
    ...
    secondary: [TAG_SLUGS.PEAU_ATOPIQUE, TAG_SLUGS.REPARATEUR, TAG_SLUGS.ANTI_AGE],
    avoid: [],
  },
  [INGREDIENT_SLUGS.EVENING_PRIMROSE_OIL]: {
    primary: [TAG_SLUGS.PEAU_ATOPIQUE, TAG_SLUGS.ECZEMA, TAG_SLUGS.BARRIERE_CUTANEE],
    secondary: [TAG_SLUGS.PEAU_SECHE, TAG_SLUGS.APAISANT, TAG_SLUGS.REPARATEUR],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.GARDENIA_FRUIT_EXTRACT]: {
    ...
    secondary: [TAG_SLUGS.PHOTO_VIEILLISSEMENT, TAG_SLUGS.TEINT_TERNE, TAG_SLUGS.PEAU_TOUS_TYPES],
    avoid: [],
  },
  ...
  [INGREDIENT_SLUGS.AZELOCALM]: {
    ...
    secondary: [TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.ANTI_ACNE, TAG_SLUGS.COUPEROSE],
    avoid: [],
  },
