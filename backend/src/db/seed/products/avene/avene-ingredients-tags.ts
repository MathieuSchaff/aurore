...
export const AVENE_INGREDIENTS_MAP: Record<string, any[]> = {
  ...
  [allProductSlugs.AVENE_HYALURON_ACTIV_PROCEDURE_CREME_LIFTING_0_1_RETINAL]: [
    {
  ...
  [allProductSlugs.AVENE_XERACALM_HUILE_LAVANTE]: [
    {
      slug: INGREDIENT_SLUGS.AQUAPHILUS_DOLOMIAE_EXTRACT,
  ...
  [allProductSlugs.AVENE_HYDRANCE_BOOST_SERUM]: [
    {
      slug: INGREDIENT_SLUGS.NIACINAMIDE,
      notes: 'Vitamine B3 hydratante et apaisante',
    },
    {
      slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE,
  ...
  [allProductSlugs.AVENE_TOLERANCE_CONTROL_BAUME]: [
    {
      slug: INGREDIENT_SLUGS.SHEA_BUTTER,
    ...
    {
      slug: INGREDIENT_SLUGS.AQUAPHILUS_DOLOMIAE_EXTRACT, // à créer
      notes: 'D-Sensinose™ — postbiotique ultra-calmant breveté',
    },
  ],

  [allProductSlugs.AVENE_HYALURON_ACTIV_B3_SERUM]: [
    {
      slug: INGREDIENT_SLUGS.NIACINAMIDE,
      value: 6,
      unit: '%',
    ...
    {
      slug: INGREDIENT_SLUGS.ADENOSINE, // à créer si absent
      notes: 'Actif anti-rides et tenseur',
    },
  ],

  [allProductSlugs.AVENE_CLEANANCE_COMEDOMED_SOIN_INTENSIF_ANTI_IMPERFECTION]: [
    {
      slug: INGREDIENT_SLUGS.NIACINAMIDE,
      value: 4,
      unit: '%',
    ...
    {
      slug: INGREDIENT_SLUGS.COMEDOCLASTIN, // à créer
      notes: 'Comedoclastin™ — réduit comédons et pores',
    },
  ],

  [allProductSlugs.AVENE_ULTRA_FLUID_INVISIBLE_SPF50]: [
    {
  ...
  [allProductSlugs.AVENE_XERACALM_NUTRITION_BAUME]: [
    {
      slug: INGREDIENT_SLUGS.HUILE_ONAGRE, // à créer si absent
      notes: 'Huile d onagre relipidante riche en GLA',
    },
    {
      slug: INGREDIENT_SLUGS.GLYCERIN,
  ...
  [allProductSlugs.AVENE_HYALURON_ACTIV_PROCEDURE_CREME_MICRO_LIFT_YEUX_LEVRES]: [
    {
      slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE,
      notes: 'Acide hyaluronique repulpant',
    },
    {
      slug: INGREDIENT_SLUGS.RETINOL, // selon gamme Procedure
      notes: 'Rétinol lissant — contour yeux et lèvres',
    },
    // {
    //   slug: INGREDIENT_SLUGS.AVENE_THERMAL_SPRING_WATER,
    //   notes: 'Eau thermale apaisante',
    // },
  ],
}
