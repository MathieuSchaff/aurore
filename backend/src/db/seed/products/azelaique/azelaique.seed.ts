...
export const AZELAIQUE_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'ml',
    priceCents: 6000,
    description: 'Sérum 10% azélaïque + niacinamide + vitamine C + bakuchiol. Éclaircissant tout-en-un pour teint terne.',
    notes: 'Texture émulsion confortable, vegan/cruelty-free. Redondance niacinamide/vit C dans une routine, prix élevé pour formule basique.',
    ...
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.ASCORBYL_GLUCOSIDE, notes: 'Vitamine C stable – antioxydant, éclat',},
...

  {
    ...
    keyIngredients: [
      {
        slug: INGREDIENT_SLUGS.AZELAIC_ACID,
        notes: '30% — concentration professionnelle. Exfoliation, renouvellement cellulaire, anti-pigmentation et anti-sébum.',},
    ],
  },

  {
    ...
    keyIngredients: [
      ...
      { slug: INGREDIENT_SLUGS.ALOE_VERA, notes: 'Base de la formule. Hydratant, apaisant et porteur naturel des actifs.',},
      {
        slug: INGREDIENT_SLUGS.NIACINAMIDE,
        notes: `Dépigmentant et anti-inflammatoire. Renforce l'action anti-taches de l'acide azélaïque.`,},
      { slug: INGREDIENT_SLUGS.SODIUM_HYALURONATE, notes: `Hydratation profonde et rétention d'eau.`,},
