...
export const DR_G_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème apaisante Cica pour peaux sensibles, irritées ou à imperfections (rougeurs, boutons).',
    notes: 'Occlusion 6.5/10. Texture crème légère. 5-Cica Complex (centella multi-formes) + niacinamide + panthenol.',
