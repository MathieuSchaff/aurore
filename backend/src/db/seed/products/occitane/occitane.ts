export const OCCITANE_PRODUCT_SLUGS = {
  IMMORTELLE_MOUSSE_NETTOYANTE: 'loccitane-immortelle-mousse-nettoyante-125ml',
  IMMORTELLE_BAUME_DEMAQUILLANT: 'loccitane-immortelle-baume-demaquillant-60g',
  IMMORTELLE_TRIPHASE_ESSENCE_RESET: 'loccitane-immortelle-triphase-essence-reset-150ml',
  IMMORTELLE_SERUM_CREME_MAINS: 'loccitane-immortelle-serum-creme-mains-75ml',
  IMMORTELLE_HUILE_CORPS_RAFFERMISSANTE: 'loccitane-immortelle-huile-corps-raffermissante-100ml',
  IMMORTELLE_HUILE_DEMAQUILLANTE: 'loccitane-immortelle-huile-demaquillante-200ml',
  IMMORTELLE_BAUME_CORPS_PRO_JEUNESSE: 'loccitane-immortelle-baume-corps-pro-jeunesse-200ml',
  IMMORTELLE_HUILE_JEUNESSE: 'loccitane-immortelle-huile-jeunesse-30ml',
  IMMORTELLE_SERUM_PRO_FERMETE: 'loccitane-immortelle-serum-pro-fermete-30ml',
  IMMORTELLE_CREME_VISAGE_PRECIEUSE: 'loccitane-immortelle-creme-visage-precieuse-50ml',
  IMMORTELLE_CREME_JEUNESSE: 'loccitane-immortelle-creme-jeunesse-50ml',
  IMMORTELLE_SERUM_RESET_NUIT: 'loccitane-immortelle-serum-reset-nuit-50ml',
  IMMORTELLE_BAUME_REGARD: 'loccitane-immortelle-baume-regard-15ml',
  IMMORTELLE_CONTOUR_YEUX_LEVRES: 'loccitane-immortelle-contour-yeux-levres-15ml',
  IMMORTELLE_CREME_COU: 'loccitane-immortelle-creme-cou-lissante-50ml',
  IMMORTELLE_EAU_ESSENTIELLE: 'loccitane-immortelle-eau-essentielle-precieuse-200ml',
} as const

export const OCCITANE_PRODUCT_DATA = [
  {
    name: 'Mousse-en-Crème Nettoyante Immortelle Divine',
    brand: "L'Occitane",
    kind: 'skincare' as const,
    unit: 'tube',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_MOUSSE_NETTOYANTE,
    totalAmount: 125,
    amountUnit: 'ml',
    priceCents: 3500,
    description:
      "Crème nettoyante onctueuse qui se transforme en mousse douce et légère au contact de l'eau. Retire délicatement le maquillage, même waterproof, et les impuretés accumulées tout au long de la journée pour révéler un teint frais et éclatant.",
    notes:
      "Enrichie en AHA exfoliants et huile essentielle d'Immortelle bio de Corse. Formule testée sous contrôle dermatologique, adaptée à tous types de peau. 97% des femmes trouvent que la mousse aide la peau à paraître plus nette.",
    inci: 'AQUA/WATER • GLYCERIN • SODIUM COCOYL GLYCINATE • COCO-BETAINE • DECYL GLUCOSIDE • HELICHRYSUM ITALICUM EXTRACT • HELICHRYSUM ITALICUM FLOWER OIL • HELIANTHUS ANNUUS (SUNFLOWER) SEED OIL • CITRIC ACID • LACTIC ACID • SODIUM CHLORIDE • XANTHAN GUM • TOCOPHERYL ACETATE • PARFUM/FRAGRANCE • BENZYL SALICYLATE • LIMONENE • LINALOOL • GERANIOL',
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'jar',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_BAUME_DEMAQUILLANT,
    totalAmount: 60,
    amountUnit: 'g',
    priceCents: 3900,
    description:
      "Baume démaquillant qui élimine efficacement le maquillage, même waterproof, tout en enveloppant la peau d'un voile de douceur. Sa texture se fond sous l'effet du massage pour se transformer en huile généreuse.",
    notes:
      "Enrichi en vitamine E et huile essentielle d'Immortelle bio de Corse. La peau est 23% plus nourrie dès la première utilisation. 100% des utilisateurs trouvent le produit efficace et doux. Packaging en verre composé à 40% de verre recyclé.",
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'bottle',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_TRIPHASE_ESSENCE_RESET,
    totalAmount: 150,
    amountUnit: 'ml',
    priceCents: 7900,
    description:
      "Essence triphase jour & nuit qui aide à équilibrer la peau et renforcer sa barrière pour un teint éclatant, apaisé et résilient. Réduit immédiatement la sensation d'inconfort de 54% et améliore visiblement l'éclat de 16%.",
    notes:
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'bottle',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_HUILE_CORPS_RAFFERMISSANTE,
    totalAmount: 100,
    amountUnit: 'ml',
    priceCents: 6900,
    description:
      "Huile corps qui allie la puissance d'un sérum pro-jeunesse avec les propriétés nourrissantes d'une huile. Améliore l'aspect froissé et renforce la barrière cutanée pour une peau visiblement plus ferme et éclatante. Des résultats similaires à ceux du rétinol.",
    notes:
      "Texture légère rapidement absorbée, sans effet gras. Enrichie en huile de rose musquée, huile d'argousier et super extrait d'Immortelle bio de Corse.",
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'bottle',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_HUILE_DEMAQUILLANTE,
    totalAmount: 200,
    amountUnit: 'ml',
    priceCents: 2900,
    description:
    ...
    notes:
      "Enrichie en huile de ricin et huile essentielle d'Immortelle bio de Corse. 97% des utilisateurs trouvent le produit efficace et doux. Formule testée sous contrôle dermatologique, adaptée à tous types de peau.",
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'jar',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_BAUME_CORPS_PRO_JEUNESSE,
    totalAmount: 200,
    amountUnit: 'ml',
    priceCents: 6900,
    description:
      "Baume corps qui hydrate la peau tout en réduisant jour après jour les signes visibles de l'âge : sécheresse, irrégularités de texture, perte de fermeté et de luminosité. Pour une peau divinement lisse, uniforme et ferme.",
    notes:
      "Texture onctueuse et fondante, absorption rapide. Enrichi en beurre de karité, extrait de pois, adénosine et super extrait d'Immortelle bio.",
    inci: 'AQUA/WATER/EAU • CAPRYLIC/CAPRIC TRIGLYCERIDE • COCO-CAPRYLATE/CAPRATE • BUTYROSPERMUM PARKII (SHEA) BUTTER • GLYCERIN • OCTYLDODECANOL • CETYL PALMITATE • PENTYLENE GLYCOL • CETEARYL ALCOHOL • TAPIOCA STARCH • CETYL ALCOHOL • HYDROXYETHYL ACRYLATE/SODIUM ACRYLOYLDIMETHYL TAURATE COPOLYMER • GLYCERYL STEARATE SE • PISUM SATIVUM (PEA) EXTRACT • HELICHRYSUM ITALICUM FLOWER/STEM EXTRACT • HELICHRYSUM ITALICUM FLOWER OIL • HELIANTHUS ANNUUS (SUNFLOWER) SEED OIL • ADENOSINE • CETEARYL GLUCOSIDE • HEXYLRESORCINOL • SODIUM STEAROYL GLUTAMATE • ETHYLHEXYLGLYCERIN • PALMITIC ACID • STEARIC ACID • CYCLODEXTRIN • SODIUM GLUCONATE • TOCOPHEROL • POLYSORBATE 60 • SORBITAN ISOSTEARATE • CITRIC ACID • CHLORPHENESIN • PARFUM/FRAGRANCE',
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'bottle',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_HUILE_JEUNESSE,
    totalAmount: 30,
    amountUnit: 'ml',
    priceCents: 9500,
    description:
      "Huile sèche visage multi-usage qui nourrit intensément la peau et agit contre les signes visibles de l'âge. Alternative naturelle au rétinol, une seule goutte rend le teint radieux. Peut être utilisée seule, avant ou après la crème, ou mélangée à votre soin.",
    notes:
      "Enrichie en super extrait d'Immortelle bio de Corse, huile de bourrache, huile de caméline, huile d'onagre et huile d'argousier. Formule sans eau, 100% huiles précieuses.",
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'pump',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_SERUM_PRO_FERMETE,
    totalAmount: 30,
    amountUnit: 'ml',
    priceCents: 9900,
    description:
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'jar',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_CREME_VISAGE_PRECIEUSE,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 6400,
    description:
      "Crème visage qui repulpe la peau et agit contre les premiers signes de l'âge. Nourrit et hydrate 24h, -39% de ridules, -14% d'apparence des pores. Pour une peau lissée, rebondie et éclatante.",
    notes:
      "Enrichie en huile essentielle d'Immortelle, super extrait aqueux d'Immortelle et extrait de lentille. 95% d'ingrédients d'origine naturelle. Adaptée aux peaux normales à sèches. Existe aussi en texture émulsion plus légère.",
    inci: 'AQUA/WATER • GLYCERIN • CETEARYL ALCOHOL • DICAPRYLYL ETHER • CETYL ALCOHOL • CETYL PALMITATE • OCTYLDODECYL MYRISTATE • BUTYROSPERMUM PARKII (SHEA) BUTTER • TAPIOCA STARCH • MYRISTYL ALCOHOL • METHYLPROPANEDIOL • DIMETHICONE • HELICHRYSUM ITALICUM FLOWER OIL • HELICHRYSUM ITALICUM EXTRACT • LENS ESCULENTA (LENTIL) FRUIT EXTRACT • HELIANTHUS ANNUUS (SUNFLOWER) SEED OIL • ADENOSINE • HYALURONIC ACID • SILANETRIOL • CETEARYL GLUCOSIDE • MYRISTYL GLUCOSIDE • CARBOMER • CAPRYLYL GLYCOL • PENTYLENE GLYCOL • ETHYLHEXYLGLYCERIN • XANTHAN GUM • SODIUM HYDROXIDE • TOCOPHEROL • CITRIC ACID • CHLORPHENESIN • SODIUM BENZOATE • POTASSIUM SORBATE • PARFUM/FRAGRANCE',
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'pump',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_SERUM_RESET_NUIT,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 9500,
    description:
      "Sérum de nuit qui réveillez votre éclat. Une peau revitalisée, reposée et lumineuse en 1 nuit. L'extrait de gardénia aide la peau à se rétablir, l'extrait d'Acmella Oleracea lisse instantanément et l'Immortelle protège contre le stress oxydant.",
    notes:
      "Formule enrichie en extrait pro-sève d'Immortelle (technologie Bio-inspiration végétale), extrait de gardénia et extrait d'Acmella Oleracea. Huiles encapsulées pour une sensorialité unique. Appliquer le soir après nettoyage.",
    inci: 'AQUA/WATER • GLYCERIN • PROPANEDIOL • COCO-CAPRYLATE/CAPRATE • BUTYLENE GLYCOL • PENTYLENE GLYCOL • DEXTRIN PALMITATE • LIMNANTHES ALBA (MEADOWFOAM) SEED OIL • 1,2-HEXANEDIOL • ACMELLA OLERACEA EXTRACT • HELICHRYSUM ITALICUM EXTRACT • HELICHRYSUM ITALICUM FLOWER OIL • GARDENIA FLORIDA FRUIT EXTRACT • HELIANTHUS ANNUUS (SUNFLOWER) SEED OIL • ADENOSINE • BETAINE • CAPRYLYL GLYCOL • CARBOMER • FRUCTOSE • TRISODIUM ETHYLENEDIAMINE DISUCCINATE • SODIUM HYDROXIDE • CELLULOSE GUM • AMODIMETHICONE • TOCOPHEROL • MALTODEXTRIN • PARFUM/FRAGRANCE • CI 40800/BETA-CAROTENE',
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'jar',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_BAUME_REGARD,
    totalAmount: 15,
    amountUnit: 'ml',
    priceCents: 6900,
    description:
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'tube',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_CREME_COU,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 6900,
    description:
      "Crème cou spécialisée qui nourrit la peau, améliore l'élasticité et la fermeté, et réduit visiblement l'apparence des plis du cou. Un aspect plus lisse, une sensation plus ferme, une confiance renforcée.",
    notes:
      "Formule avec peptides de matrikines (palmitoyl tripeptide-1 et tétrapeptide-7) pour le lissage et la fermeté. Enrichie en acide hyaluronique, extrait d'avoine et Immortelle bio de Corse.",
    inci: 'AQUA/WATER/EAU • GLYCERIN • BUTYROSPERMUM PARKII (SHEA) BUTTER • TAPIOCA STARCH • COCO-CAPRYLATE/CAPRATE • HYDROXYETHYL ACRYLATE/SODIUM ACRYLOYLDIMETHYL TAURATE COPOLYMER • AVENA SATIVA (OAT) KERNEL EXTRACT • HELICHRYSUM ITALICUM FLOWER/STEM EXTRACT • HELICHRYSUM ITALICUM FLOWER OIL • HELIANTHUS ANNUUS (SUNFLOWER) SEED OIL • MYRTUS COMMUNIS OIL • HYALURONIC ACID • PALMITOYL TRIPEPTIDE-1 • PALMITOYL TETRAPEPTIDE-7 • BUTYLENE GLYCOL • CAPRYLYL GLYCOL • ARACHIDYL ALCOHOL • XANTHAN GUM • ETHYLHEXYLGLYCERIN • BEHENYL ALCOHOL • SODIUM GLUCONATE • POLYSORBATE 60 • SORBITAN ISOSTEARATE • ARACHIDYL GLUCOSIDE • CAPRYLIC/CAPRIC TRIGLYCERIDE • SODIUM LACTATE • CARBOMER • TOCOPHEROL • PENTYLENE GLYCOL • MAGNESIUM ASPARTATE • ZINC GLUCONATE • SODIUM HYDROXIDE • POLYSORBATE 20 • COPPER GLUCONATE • CHLORPHENESIN • SODIUM BENZOATE • PARFUM/FRAGRANCE',
  ...
  },
  {
    ...
    kind: 'skincare' as const,
    unit: 'bottle',
    slug: OCCITANE_PRODUCT_SLUGS.IMMORTELLE_EAU_ESSENTIELLE,
    totalAmount: 200,
    amountUnit: 'ml',
    priceCents: 2500,
    description:
      "Tonique qui délivre un voile d'hydratation pour une peau rayonnante, comme énergisée, et un grain de peau lissé. Enrichi en acide hyaluronique hydratant et super extrait aqueux d'Immortelle bio de Corse.",
    notes:
      "Formule légère pour l'étape tonique de la routine. Polyphénols de l'Immortelle aux propriétés antioxydantes. Enrichi en extrait de lentille et sodium PCA pour compléter l'hydratation.",
    inci: 'AQUA/WATER • GLYCERIN • POLYSORBATE 20 • HELICHRYSUM ITALICUM EXTRACT • LENS ESCULENTA (LENTIL) FRUIT EXTRACT • SODIUM PCA • SODIUM HYALURONATE • LEVULINIC ACID • SODIUM LEVULINATE • SODIUM HYDROXIDE • PENTYLENE GLYCOL • CITRIC ACID • SODIUM BENZOATE • PARFUM/FRAGRANCE • HEXYL CINNAMAL • BENZYL SALICYLATE • ALPHA-ISOMETHYL IONONE • CITRAL • LIMONENE',
