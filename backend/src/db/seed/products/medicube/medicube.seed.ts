...
export const MEDICUBE_SEED: UnifiedProductSeed[] = [
  {
    ...
    amountUnit: 'ct',
    priceCents: 0,
    description: 'Pads exfoliants et apaisants à la Centella Asiatica pour apaiser les peaux sensibles et irritées.',
    notes: 'Centella Asiatica + Acide Hyaluronique + Ectoin + Acide Salicylique. Idéal pour peaux réactives et sensibles.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/27D90EDF51FF27/large_1730180051.jpeg?1730180051',
    tags: {
      primary: [TAG_SLUGS.APAISANT, TAG_SLUGS.BARRIERE_CUTANEE],
      secondary: [TAG_SLUGS.PEAU_SENSIBLE, TAG_SLUGS.PEAU_REACTIVE, TAG_SLUGS.MATIN, TAG_SLUGS.SOIR],
      avoid: [],
    },
    keyIngredients: [
  ...
  },
  {
    ...
    notes: 'Soufre Colloïdal + Acide Salicylique + Niacinamide + Tea Tree. Idéal pour peaux grasses à tendance acnéique.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/F8BED66F8DC361/large_1715502141.pngpng?1715502141',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ct',
    priceCents: 0,
    description: 'Pads tonifiants à double exfoliation pour resserrer les pores dilatés et unifier le teint.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/32CA87DEE2DE66/large_1677985769.jpeg?1677985769',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème hydratante aux pores affinée combinant Panthénol 5%, BHA et Niacinamide pour une peau lissée et lumineuse.',
    notes: 'Panthénol 5% + BHA 0,1% + Niacinamide 2% + Acide Hyaluronique multi-poids. Idéal pour peaux à pores dilatés et teint terne.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/3723493C322206/large_1749886123.pngpng?1749886123',
    tags: {
  ...
  },
  {
    ...
    notes: 'Bétaïne Salicylate + Acide Lactique + Centella Asiatica + Extraits botaniques. Idéal pour peaux mixtes à grasses avec pores visibles.',
    inci: 'WATER, GLYCERIN, ALCOHOL DENAT., BUTYLENE GLYCOL, METHYLPROPANEDIOL, GLYCERETH-26, BETAINE, BETAINE SALICYLATE, LACTIC ACID, SALICYLIC ACID, SALIX ALBA (WILLOW) BARK EXTRACT, CENTELLA ASIATICA EXTRACT, SODIUM HYALURONATE, PANTHENOL, TREHALOSE, LACTOBACILLUS/SOYBEAN FERMENT EXTRACT, CHAMAECYPARIS OBTUSA LEAF EXTRACT, CINNAMOMUM CASSIA BARK EXTRACT, SCUTELLARIA BAICALENSIS ROOT EXTRACT, PORTULACA OLERACEA EXTRACT, OENOTHERA BIENNIS (EVENING PRIMROSE) FLOWER EXTRACT, ORIGANUM VULGARE LEAF EXTRACT, PINUS PALUSTRIS LEAF EXTRACT, PUERARIA LOBATA ROOT EXTRACT, ULMUS DAVIDIANA ROOT EXTRACT, VITIS VINIFERA (GRAPE) FRUIT EXTRACT, CITRUS AURANTIFOLIA (LIME) FRUIT EXTRACT, CITRUS AURANTIUM DULCIS (ORANGE) FRUIT EXTRACT, PYRUS MALUS (APPLE) FRUIT EXTRACT, CITRUS AURANTIUM BERGAMIA (BERGAMOT) FRUIT OIL, CITRUS AURANTIUM DULCIS (ORANGE) PEEL OIL, CITRUS GRANDIS (GRAPEFRUIT) PEEL OIL, CITRUS LIMON (LEMON) FRUIT EXTRACT, CITRUS LIMON (LEMON) PEEL OIL, EUCALYPTUS GLOBULUS LEAF OIL, LAVANDULA ANGUSTIFOLIA (LAVENDER) OIL, ROSMARINUS OFFICINALIS (ROSEMARY) LEAF OIL, POLYGLYCERYL-10 LAURATE, POLYGLYCERYL-10 MYRISTATE, AMMONIUM ACRYLOYLDIMETHYLTAURATE/VP COPOLYMER, TROMETHAMINE, LIMONENE, ETHYL HEXANEDIOL, ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL, DISODIUM EDTA',
    url: 'https://www.skinsafeproducts.com/medicube-zero-pore-pad-2-0-5-46-oz-155-g-70-count-0',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/4F4864FEC4C022/large_1747549943.pngpng?1747549943',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème anti-taches multi-actifs à la vitamine C stabilisée, Niacinamide et peptides pour corriger les hyperpigmentations.',
    notes: '3-O-Éthyl Ascorbique + Ascorbyl Glucoside + Niacinamide + Palmitoyl Peptides. Idéal pour peaux matures avec taches et rides.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/EA54A49C829C14/large_1689318243.pngpng?1689318243',
    tags: {
  ...
  },
  {
    ...
    notes: 'Acide Azélaïque 16% + Niacinamide + Céramide NP + Squalane. Idéal pour peaux sensibles, rosacée, ou sujettes aux rougeurs.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/22A2207C9D1D05/large_1755755948.pngpng?1755755948',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque de nuit au collagène et à la Niacinamide pour repulper, raffermir et éclater le teint pendant le sommeil.',
    notes: 'Collagène + Niacinamide + Céramide NP + Hyaluronate de Sodium. Idéal pour peaux déshydratées cherchant repulpage nocturne.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/21C0A6C2E29792/large_1754045586.pngpng?1754045586',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum concentré à triple exfoliation pour minimiser les pores, lisser le grain de peau et illuminer le teint.',
    notes: 'AHA (Glycolique + Lactique) + BHA (Salicylique) + Niacinamide + Acide Hyaluronique multi-poids. Idéal pour peaux mixtes à pores dilatés.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/0C17C6E2B278B6/large_1743746010.pngpng?1743746010',
    tags: {
      primary: [TAG_SLUGS.PORES_DILATES, TAG_SLUGS.EXFOLIATION],
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque wrap au collagène et à la protéine de lait pour repulper, unifier et illuminer le teint en profondeur.',
    notes: 'Collagène + Alpha-Arbutine + Niacinamide + Glutathion + Haematococcus. Idéal pour peaux ternes cherchant éclat et repulpage.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/14167F263AEEE2/large_1757825806.pngpng?1757825806',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ct',
    priceCents: 0,
    description: 'Masques gel au PDRN, collagène et complexe de peptides pour régénérer, repulper et raffermir intensément la peau.',
    notes: 'ADN Sodique (PDRN) + Collagène Hydrolysé + 9 Peptides actifs + Copper Tripeptide-1. Idéal pour peaux matures ou fatiguées recherchant une régénération.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/5F51D03A33C7F0/large_1753338517.pngpng?1753338517',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème nourrissante à triple source de collagène pour restaurer la densité cutanée et atténuer les rides.',
    notes: 'Collagène Extrait + Collagène Hydrolysé + Collagène Soluble + Niacinamide + Squalane. Idéal pour peaux sèches ou en perte de fermeté.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/EC68A704A59410/large_1747642414.pngpng?1747642414',
    tags: {
  ...
  },
  {
    ...
    notes: 'Acide Kojique + Curcuma + Niacinamide + Rétinol + Collagène. Idéal pour peaux à taches et teint irrégulier.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/B0F4E24495BF49/large_1755514906.pngpng?1755514906',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Brume sérum au glutathion et aux peptides pour illuminer le teint, renforcer la densité cutanée et hydrater en continu.',
    notes: 'Glutathion + ADN Sodique + Niacinamide + Complexe Peptides (Hexapeptide-2, Hexapeptide-9). Idéal pour peaux ternes recherchant éclat et anti-âge.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/4F18AAFE5EDA21/large_1755049630.jpeg?1755049630',
    tags: {
  ...
  },
  {
    ...
    notes: 'Bétaïne Salicylate + Acide Lactique + Centella Asiatica + Extraits botaniques coréens. Idéal pour peaux mixtes avec pores dilatés.',
    inci: 'WATER, GLYCERIN, ALCOHOL DENAT, BUTYLENE GLYCOL, METHYLPROPANEDIOL, GLYCERETH-26, BETAINE, BETAINE SALICYLATE, LACTIC ACID, SALICYLIC ACID, SALIX ALBA (WILLOW) BARK EXTRACT, CENTELLA ASIATICA EXTRACT, SODIUM HYALURONATE, PANTHENOL, TREHALOSE, LACTOBACILLUS/SOYBEAN FERMENT EXTRACT, CHAMAECYPARIS OBTUSA LEAF EXTRACT, CINNAMOMUM CASSIA BARK EXTRACT, SCUTELLARIA BAICALENSIS ROOT EXTRACT, PORTULACA OLERACEA EXTRACT, OENOTHERA BIENNIS (EVENING PRIMROSE) FLOWER EXTRACT, ORIGANUM VULGARE LEAF EXTRACT, PINUS PALUSTRIS LEAF EXTRACT, PUERARIA LOBATA ROOT EXTRACT, ULMUS DAVIDIANA ROOT EXTRACT, VITIS VINIFERA (GRAPE) FRUIT EXTRACT, CITRUS AURANTIFOLIA (LIME) FRUIT EXTRACT, CITRUS AURANTIUM DULCIS (ORANGE) FRUIT EXTRACT, PYRUS MALUS (APPLE) FRUIT EXTRACT, CITRUS AURANTIUM BERGAMIA (BERGAMOT) FRUIT OIL, CITRUS AURANTIUM DULCIS (ORANGE) PEEL OIL, CITRUS GRANDIS (GRAPEFRUIT) PEEL OIL, CITRUS LIMON (LEMON) FRUIT EXTRACT, CITRUS LIMON (LEMON) PEEL OIL, EUCALYPTUS GLOBULUS LEAF OIL, LAVANDULA ANGUSTIFOLIA (LAVENDER) OIL, ROSMARINUS OFFICINALIS (ROSEMARY) LEAF OIL, POLYGLYCERYL-10 LAURATE, POLYGLYCERYL-10 MYRISTATE, AMMONIUM ACRYLOYLDIMETHYLTAURATE/VP COPOLYMER, TROMETHAMINE, LIMONENE, ETHYL HEXANEDIOL, ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL, DISODIUM EDTA',
    url: 'https://www.skinsafeproducts.com/medicube-zero-pore-pad-5-46-oz-155-g-count-70',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/0C4D0D724AD926/large_1749795879.pngpng?1749795879',
    tags: {
      primary: [TAG_SLUGS.PORES_DILATES, TAG_SLUGS.EXFOLIATION],
  ...
  },
  {
    ...
    notes: 'Acide Kojique + Curcuma + Niacinamide + Rétinol + Collagène Hydrolysé. Idéal pour peaux à hyperpigmentation et teint irrégulier.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/981708488F9873/large_1748169967.pngpng?1748169967',
    tags: {
      primary: [TAG_SLUGS.ANTI_TACHES, TAG_SLUGS.ECLAT],
  ...
  },
  {
    ...
    notes: 'Glutathion + Alpha-Arbutine + Niacinamide + Acide Alpha-Lipoïque + Peptides. Idéal pour peaux ternes avec imperfections et taches.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/738B9E4F68B209/large_1744688832.pngpng?1744688832',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum booster aux exosomes de Lactobacillus pour régénérer, réparer et renforcer la barrière cutanée en cure intensive.',
    notes: 'Exosomes Lactobacillus (2000 ppm) + Niacinamide + Gluconolactone + Panthénol. Idéal pour peaux sensibles ou abîmées nécessitant une régénération.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/6349C742857F2B/large_1744089187.jpeg?1744089187',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ct',
    priceCents: 0,
    description: 'Pads à la Gluconolactone et à la Madecassoside pour purifier, hydrater et refiner le grain de peau en douceur.',
    notes: 'Gluconolactone (PHA) + Madecassoside + Acide Hyaluronique multi-poids + Eau de Rose. Idéal pour peaux sensibles cherchant exfoliation douce et hydratation.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/5A155D659136C0/large_1744093133.pngpng?1744093133',
    tags: {
  ...
  },
  {
    ...
    notes: 'Potassium Cocoate + Sodium Cocoyl Isethionate + Extrait de Portulaca + Lécithine. Idéal pour tous types de peau, y compris sensibles.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/B699359C0D4B71/large_1744092400.pngpng?1744092400',
    tags: {
  ...
  },
  {
    ...
    notes: 'Collagène Extrait + Niacinamide + Céramide NP + Hyaluronate de Sodium. Idéal pour peaux déshydratées ou en manque de fermeté.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/B4B8DD9FE42AC7/large_1714297053.pngpng?1714297053',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum booster haute concentration aux exosomes de Lactobacillus pour une régénération cellulaire accélérée et une réparation cutanée intensive.',
    notes: 'Exosomes Lactobacillus (7500 ppm) + Niacinamide + Gluconolactone + Panthénol. Idéal pour peaux abîmées, post-procédure ou en besoin de régénération intense.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/25F9443ADBE139/large_1726179087.jpeg?1726179087',
    tags: {
      primary: [TAG_SLUGS.REPARATEUR, TAG_SLUGS.BARRIERE_CUTANEE],
  ...
  },
  {
    ...
    notes: 'ADN Sodique (PDRN) + Exosomes de Lait + Collagène + Rétinol + Peptides (Palmitoyl Pentapeptide-4, Palmitoyl Tripeptide-5). Idéal pour peaux matures ou après des procédures esthétiques.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/AD0438B66517FC/large_1753977061.jpeg?1753977061',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'g',
    priceCents: 0,
    description: 'Crème capsule riche au PDRN, glutathion et collagène hydrolysé pour régénérer, raffermir et illuminer intensément la peau.',
    notes: 'ADN Sodique + Glutathion + Collagène Hydrolysé + Copper Tripeptide-1 + Acide Alpha-Lipoïque. Idéal pour peaux matures cherchant repulpage et éclat.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/17FA32C45EC237/large_1755451142.jpeg?1755451142',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Toner lacté au PDRN, Niacinamide et complexe céramides pour hydrater profondément, renforcer la barrière et illuminer le teint.',
    notes: 'ADN Sodique (PDRN) + Niacinamide + Céramides (AP, EOP, NP, NS) + Protéines hydrolysées (Riz, Blé, Soja). Idéal pour peaux sèches ou sensibles cherchant hydratation et éclat.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/238D7EEF562D2F/large_1754788578.jpeg?1754788578',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Sérum éclat anti-âge au glutathion, collagène soluble et céramides pour corriger les taches et renforcer la barrière cutanée.',
    notes: 'Glutathion + Glucosylrutine + Niacinamide + Collagène Soluble + Céramide NP. Idéal pour peaux matures ou ternes cherchant éclat et anti-oxydation.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/6D0477A1D864F2/large_1748671466.jpeg?1748671466',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème gel texture jelly au triple collagène, squalane et extraits de légumes verts pour hydrater et raffermir le teint.',
    notes: 'Collagène (Extrait + Hydrolysé + Soluble) + Niacinamide + Squalane + ADN Sodique. Idéal pour toutes peaux cherchant hydratation fraîche et repulpage.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/B9DE620778E271/large_1744777731.jpegjpeg?1744777731',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Crème gel jelly légère au triple collagène et aux extraits végétaux pour hydrater, raffermir et illuminer le teint au quotidien.',
    notes: 'Collagène (Extrait + Hydrolysé + Soluble) + Niacinamide + Squalane + ADN Sodique. Idéal pour peaux normales à mixtes cherchant hydratation et légèreté.',
    inci: 'WATER, GLYCERIN, BUTYLENE GLYCOL, DIPROPYLENE GLYCOL, ETHOXYDIGLYCOL, METHYLPROPANEDIOL, COLLAGEN, HYDROLYZED COLLAGEN, SOLUBLE COLLAGEN, SOLUBLE PROTEOGLYCAN, HYDROLYZED ELASTIN, NIACINAMIDE, SQUALANE, SODIUM DNA, SALMON EGG EXTRACT, CAMELLIA SINENSIS SEED EXTRACT, AVENA SATIVA (OAT) KERNEL EXTRACT, ALLIUM SATIVUM (GARLIC) BULB EXTRACT, ALTHAEA ROSEA FLOWER EXTRACT, BERTHOLLETIA EXCELSA SEED EXTRACT, BRASSICA OLERACEA ITALICA (BROCCOLI) EXTRACT, CHLORELLA VULGARIS EXTRACT, CYNANCHUM ATRATUM EXTRACT, SOLANUM LYCOPERSICUM (TOMATO) FRUIT EXTRACT, SPINACIA OLERACEA (SPINACH) LEAF EXTRACT, VACCINIUM ANGUSTIFOLIUM (BLUEBERRY) FRUIT EXTRACT, WINE EXTRACT, HYDROXYPROPYLTRIMONIUM HYALURONATE, PULLULAN, FRUCTOOLIGOSACCHARIDES, FRUCTOSE, GLUCOSE, TREHALOSE, SUCROSE, TOCOPHEROL, ADENOSINE, CYANOCOBALAMIN, POLYGLYCERYL-10 ISOSTEARATE, POLYGLYCERYL-10 OLEATE, AMMONIUM ACRYLOYLDIMETHYLTAURATE/BEHENETH-25 METHACRYLATE CROSSPOLYMER, CARBOMER, TROMETHAMINE, SODIUM PHYTATE, DIETHOXYETHYL SUCCINATE, FRAGRANCE(PARFUM), ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL',
    url: 'https://www.skinsafeproducts.com/medicube-collagen-jelly-cream-1-69-fl-oz-50-ml',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/0CC045E521162E/large_1744088991.jpeg?1744088991',
    tags: {
      primary: [TAG_SLUGS.HYDRATATION, TAG_SLUGS.REPULPANT],
  ...
  },
  {
    ...
    amountUnit: 'ct',
    priceCents: 0,
    description: 'Masques gel au PDRN, collagène et complexe de 9 peptides actifs pour booster la régénération et la fermeté cutanée.',
    notes: 'ADN Sodique (PDRN) + Collagène Hydrolysé + Copper Tripeptide-1 + Palmitoyl Pentapeptide-4. Idéal pour peaux matures ou en besoin de régénération intensive.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/3338FCEE6E14A3/large_1744088861.jpeg?1744088861',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Toner apaisant au PDRN et à la Centella Asiatica pour calmer les rougeurs, renforcer la barrière et hydrater durablement.',
    notes: 'ADN Sodique (PDRN) + Centella Asiatica + Gluconolactone + Copper Tripeptide-1 + Niacinamide. Idéal pour peaux sensibles, réactives ou rougissantes.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/66E9B20162737A/large_1744088794.jpeg?1744088794',
    tags: {
  ...
  },
  {
    ...
    amountUnit: 'g',
    priceCents: 0,
    description: 'Masque gel unitaire au PDRN et collagène pour une cure anti-âge ciblée, repulpante et régénérante.',
    notes: 'ADN Sodique (PDRN) + Collagène Hydrolysé + 9 Peptides Actifs + Niacinamide + Panthénol. Idéal pour peaux matures cherchant repulpage et éclat express.',
    inci: 'WATER, GLYCERIN, BUTYLENE GLYCOL, PROPANEDIOL, METHYLPROPANEDIOL, DEXTRIN, HYDROLYZED COLLAGEN, NIACINAMIDE, PANTHENOL, SODIUM DNA, CARNOSINE, ADENOSINE, ALLANTOIN, TOCOPHEROL, ASCORBIC ACID, ASCORBIC ACID POLYPEPTIDE, CYANOCOBALAMIN, ACETYL HEXAPEPTIDE-8, ACETYL OCTAPEPTIDE-3, ACETYL TETRAPEPTIDE-2, ACETYL TETRAPEPTIDE-3, ACETYL TETRAPEPTIDE-5, ACETYL TETRAPEPTIDE-9, COPPER TRIPEPTIDE-1, PALMITOYL PENTAPEPTIDE-4, PALMITOYL TRIPEPTIDE-1, PALMITOYL TRIPEPTIDE-5, NONAPEPTIDE-1, BETAINE, HYDROXYACETOPHENONE, POLYGLYCERYL-10 LAURATE, LAURETH-21, POTASSIUM CHLORIDE, XANTHAN GUM, CERATONIA SILIQUA (CAROB) GUM, CYAMOPSIS TETRAGONOLOBA (GUAR) GUM, CHONDRUS CRISPUS POWDER, GLUCOMANNAN, CELLULOSE GUM, ACRYLATES/ETHYLHEXYL ACRYLATE COPOLYMER, FRAGRANCE (PARFUM), ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL',
    url: 'https://www.skinsafeproducts.com/medicube-pdrn-pink-collagen-gel-mask-0-98-oz-28-g',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/0AF2CCA1745E08/large_1732388398.jpeg?1732388398',
    tags: {
      primary: [TAG_SLUGS.REPULPANT, TAG_SLUGS.ANTI_AGE],
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Grande taille de la crème gel jelly au triple collagène pour une hydratation continue, un raffermissement et un éclat durable.',
    notes: 'Collagène (Extrait + Hydrolysé + Soluble) + Niacinamide + Squalane + ADN Sodique. Idéal pour toutes peaux cherchant un soin complet hydratant et raffermissant.',
    inci: 'WATER, GLYCERIN, BUTYLENE GLYCOL, DIPROPYLENE GLYCOL, ETHOXYDIGLYCOL, METHYLPROPANEDIOL, COLLAGEN, HYDROLYZED COLLAGEN, SOLUBLE COLLAGEN, SOLUBLE PROTEOGLYCAN, HYDROLYZED ELASTIN, NIACINAMIDE, SQUALANE, SODIUM DNA, SALMON EGG EXTRACT, CAMELLIA SINENSIS SEED EXTRACT, AVENA SATIVA (OAT) KERNEL EXTRACT, ALLIUM SATIVUM (GARLIC) BULB EXTRACT, ALTHAEA ROSEA FLOWER EXTRACT, BERTHOLLETIA EXCELSA SEED EXTRACT, BRASSICA OLERACEA ITALICA (BROCCOLI) EXTRACT, CHLORELLA VULGARIS EXTRACT, CYNANCHUM ATRATUM EXTRACT, SOLANUM LYCOPERSICUM (TOMATO) FRUIT EXTRACT, SPINACIA OLERACEA (SPINACH) LEAF EXTRACT, VACCINIUM ANGUSTIFOLIUM (BLUEBERRY) FRUIT EXTRACT, WINE EXTRACT, HYDROXYPROPYLTRIMONIUM HYALURONATE, PULLULAN, FRUCTOOLIGOSACCHARIDES, FRUCTOSE, GLUCOSE, TREHALOSE, SUCROSE, TOCOPHEROL, ADENOSINE, CYANOCOBALAMIN, POLYGLYCERYL-10 ISOSTEARATE, POLYGLYCERYL -10 OLEATE, AMMONIUM ACRYLOYLDIMETHYLTAURATE/BEHENETH-25 METHACRYLATE CROSSPOLYMER, CARBOMER, TROMETHAMINE, SODIUM PHYTATE, DIETHOXYETHYL SUCCINATE, FRAGRANCE(PARFUM), ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL',
    url: 'https://www.skinsafeproducts.com/medicube-jelly-cream-collagen-3-71-fl-oz-110-ml',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/A83CD1E9CE2015/large_1720422358.pngpng?1720422358',
    tags: {
      primary: [TAG_SLUGS.HYDRATATION, TAG_SLUGS.REPULPANT],
  ...
  },
  {
    ...
    notes: 'Acide Lactique + Bétaïne Salicylate + Panthénol + Centella Asiatica. Idéal pour peaux mixtes à sensibles avec pores dilatés.',
    inci: 'WATER, GLYCERIN, ALCOHOL DENAT, BUTYLENE GLYCOL, METHYLPROPANEDIOL, GLYCERETH-26, BETAINE, BETAINE SALICYLATE, LACTIC ACID, SALICYLIC ACID, SALIX ALBA (WILLOW) BARK EXTRACT, CENTELLA ASIATICA EXTRACT, SODIUM HYALURONATE, PANTHENOL, TREHALOSE, LACTOBACILLUS/SOYBEAN FERMENT EXTRACT, CHAMAECYPARIS OBTUSA LEAF EXTRACT, CINNAMOMUM CASSIA BARK EXTRACT, SCUTELLARIA BAICALENSIS ROOT EXTRACT, PORTULACA OLERACEA EXTRACT, OENOTHERA BIENNIS (EVENING PRIMROSE) FLOWER EXTRACT, ORIGANUM VULGARE LEAF EXTRACT, PINUS PALUSTRIS LEAF EXTRACT, PUERARIA LOBATA ROOT EXTRACT, ULMUS DAVIDIANA ROOT EXTRACT, VITIS VINIFERA (GRAPE) FRUIT EXTRACT, CITRUS AURANTIFOLIA (LIME) FRUIT EXTRACT, CITRUS AURANTIUM DULCIS (ORANGE) FRUIT EXTRACT, PYRUS MALUS (APPLE) FRUIT EXTRACT, CITRUS AURANTIUM BERGAMIA (BERGAMOT) FRUIT OIL, CITRUS AURANTIUM DULCIS (ORANGE) PEEL OIL, CITRUS GRANDIS (GRAPEFRUIT) PEEL OIL, CITRUS LIMON (LEMON) FRUIT EXTRACT, CITRUS LIMON (LEMON) PEEL OIL, EUCALYPTUS GLOBULUS LEAF OIL, LAVANDULA ANGUSTIFOLIA (LAVENDER) OIL, ROSMARINUS OFFICINALIS (ROSEMARY) LEAF OIL, POLYGLYCERYL-10 LAURATE, POLYGLYCERYL-10 MYRISTATE, AMMONIUM ACRYLOYLDIMETHYLTAURATE/VP COPOLYMER, TROMETHAMINE, LIMONENE, ETHYL HEXANEDIOL, ETHYLHEXYLGLYCERIN, 1,2-HEXANEDIOL, DISODIUM EDTA',
    url: 'https://www.skinsafeproducts.com/medicube-zero-pore-pad-2-0-lactic-acid-panthenol-5-46-oz-155-g-70-count',
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/FF87C8E20B4E7E/large_1731061501.pngpng?1731061501',
    tags: {
      primary: [TAG_SLUGS.PORES_DILATES, TAG_SLUGS.EXFOLIATION],
  ...
  },
  {
    ...
    amountUnit: 'ml',
    priceCents: 0,
    description: 'Masque en tissu au complexe de peptides et à la Centella Asiatica pour lisser, raffermir et illuminer intensément la peau.',
    notes: 'Palmitoyl Tripeptide-5 + Acetyl Dipeptide-1 Cetyl Ester + Centella Asiatica + Bifida Ferment Lysate + Céramide NP. Idéal pour peaux matures ou fatiguées.',
    ...
    imageUrl: 'https://cdn1.skinsafeproducts.com/photo/BB610CF94B6290/large_1695355442.pngpng?1695355442',
    tags: {
      primary: [TAG_SLUGS.REPULPANT, TAG_SLUGS.ECLAT],
      secondary: [TAG_SLUGS.MASQUE_TISSU, TAG_SLUGS.ANTI_AGE],
      avoid: [],
