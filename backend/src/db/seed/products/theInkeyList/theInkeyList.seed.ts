...
export const THE_INKEY_LIST_SEED: UnifiedProductSeed[] = [
  {
    ...
    notes: 'Formulation clean et minimaliste. Absorption rapide, non comédogène. Convient aux peaux sensibles. Contient huile de carthame et squalane pour renforcer la barrière cutanée. Sans parfum.',
    ...
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.UREA, concentrationValue: 10, concentrationUnit: '%', notes: 'Concentration optimale pour visage: hydrate et exfolie délicatement sans agresser.',},
      { slug: INGREDIENT_SLUGS.COLLOIDAL_OATMEAL, notes: `Farine d'avoine colloïdale apaisante. Idéale pour peaux sensibles et réactives.`,},
      { slug: INGREDIENT_SLUGS.SQUALANE, notes: 'Squalane végétal émollient léger. Renforce barrière sans effet gras.',},
      { slug: INGREDIENT_SLUGS.HUILE_CARTHAME, notes: 'Huile de carthame riche en acide linoléique. Nourrissante et réparatrice.',},
      { slug: INGREDIENT_SLUGS.CAPRYLIC_CAPRIC_TRIGLYCERIDE, notes: 'Triglycérides légers émolients. Texture fluide et absorption rapide.',},
      { slug: INGREDIENT_SLUGS.CETEARYL_ALCOHOL, notes: 'Alcool gras émollient et stabilisant. Texture crème confortable.',},
    ],
  },

  {
    ...
    keyIngredients: [
      { slug: INGREDIENT_SLUGS.AZELAIC_ACID, notes: '10% — réduit les rougeurs, unifie le teint, apaise la peau.',},
      { slug: INGREDIENT_SLUGS.ALLANTOIN, notes: `Agent apaisant et kératolytique doux. Renforce la tolérance à l'acide azélaïque.`,},
