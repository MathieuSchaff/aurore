...
| ~~F6~~ | ~~**Cleanup drift `texture-eau/huile/baume/lait/gel`**~~ ✅ Done 2026-05-10 (migration `0055`). Décisions Q1-Q6 (cf. `AUTO-TAGS-TEXTURE.md` §10.5) : cleanser/body-wash exclus du texture (cohérence rinse-off), `detectTextureBaumeFromName` étendu à moisturizer (+pattern `ointment`, +veto `lavant\|douche\|lèvres\|levers\|lip\|rasage`), 5 admin field updates pour cas single-product (Q4 lait + Q5 eau exfoliants), gel full-detector-driven. Pattern unifié 0054 : DELETE non-déterministe, backfill recrée. **Net −123 paires legacy, +52 correctes.** DB finale : creme 725, eau 228, baume 94, lait 95, gel 100, huile 27. | M | Done |
