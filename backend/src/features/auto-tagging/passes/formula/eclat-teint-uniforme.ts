...
// algo-derm fires on niacinamide/ascorbic acid presence even when marketed for anti-age,
// acne or SPF. Gate requires explicit skin-tone/radiance vocabulary in the name/claim.
