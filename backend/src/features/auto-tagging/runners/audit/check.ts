...
// return the FAIL count. Tags absent from the budget table FAIL: every emitter
// needs an explicit budget, so a missing one is caught instead of passing silently.
