...
// That alignment is what fallow reads as a clone. Extracting it would merge two vocabularies
// that are allowed to diverge, and already do: RACINES_GRASSES exists here only
