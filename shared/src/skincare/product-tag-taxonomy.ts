import { type ProductTagSlug, SKINCARE_PRODUCT_TAG_SLUGS } from './product-tag-slugs'
...
const PRODUCT_TYPE: ProductTagSlug[] = [
  ...
  SKINCARE_PRODUCT_TAG_SLUGS.DENTIFRICE,
  SKINCARE_PRODUCT_TAG_SLUGS.BAIN_DE_BOUCHE,
  SKINCARE_PRODUCT_TAG_SLUGS.BLANCHIMENT_DENTAIRE,
  SKINCARE_PRODUCT_TAG_SLUGS.FIL_DENTAIRE,
  SKINCARE_PRODUCT_TAG_SLUGS.GELULE,
  SKINCARE_PRODUCT_TAG_SLUGS.CAPSULE,
  SKINCARE_PRODUCT_TAG_SLUGS.POUDRE,
  SKINCARE_PRODUCT_TAG_SLUGS.SIROP,
  SKINCARE_PRODUCT_TAG_SLUGS.GUMMY,
