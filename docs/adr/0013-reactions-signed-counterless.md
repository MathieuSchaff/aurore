...
- `reactable_type` deliberately excludes `review`; the service rejects it. A Review is a deposit leaf, not a conversation surface (antipattern #29, "feuille-dépôt").
