...
- **Status: implemented.** Admin and contributor share one moderation shell, `createAdminGuardedRouter` in `backend/src/features/admin/_guarded-router.ts`: the role guard is the only thing that varies between them.
