    ...
    <div className="privacy-page">
      <div className="privacy-page__inner">
        ...
        <details className="privacy-legal">
          <summary className="privacy-legal__trigger">
        ...
        <section className="privacy-block">
          ...
          <p>
            ...
            <strong>Mathieu Schaff</strong>, responsable de traitement.
          </p>
          <p>
            Contact :{' '}
        ...
        <section className="privacy-block">
          ...
          <ul className="privacy-list">
            <li>
              <strong>Données de compte (email, username, avatar) :</strong> exécution du contrat
              (Art. 6(1)(b)) — nécessaires pour créer et gérer votre compte.
            </li>
            <li>
              <strong>Données d'usage (habitudes, produits, tâches, profil de peau) :</strong>{' '}
              exécution du contrat (Art. 6(1)(b)) — constituent le service que vous avez demandé.
            </li>
            <li>
            ...
            <li>
              ...
              uniquement si vous l'activez dans vos réglages. Vous pouvez révoquer ce consentement
            ...
            <li>
              ...
              sécurité et stabilité du service. Ces données sont anonymisées et ne permettent pas
              de vous identifier.
            </li>
          </ul>
        ...
        <section className="privacy-block">
          ...
          <ul className="privacy-list">
            ...
            <li>
              <strong>Médias et CDN :</strong> Bunny CDN / Object Storage (entreprise slovène, UE),
              infrastructure Europe uniquement.
            </li>
            <li>
        ...
        <section className="privacy-block">
          ...
          <ul className="privacy-list">
            <li>
              ...
              — une introduction claire au RGPD par l'autorité française de protection des données.
            </li>
            <li>
              <a
