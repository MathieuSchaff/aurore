    ...
    <section className="aur-about-section" aria-labelledby="aur-about-collab-title">
      ...
      <div className="aur-about-collab">
        ...
        <article className="aur-about-inci" aria-label="Aperçu d’une fiche ingrédient">
          ...
          <div className="aur-about-inci__contrib">
            <span>
              <Users size={12} style={{ verticalAlign: '-1px', marginRight: 6 }} />
              Fiche relue par 3 contributrices · dernière mise à jour il y a 2 jours
            </span>
            <span className="aur-about-inci__contrib-avatars" aria-hidden="true">
              <span>A</span>
              <span>M</span>
              <span>L</span>
            </span>
